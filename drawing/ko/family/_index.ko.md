---
title: 2D 도면 API - Aspose 
weight: 10
url: /ko/family
description: 모든 플랫폼에서 선, 곡선, 그림 및 다중 스타일 텍스트와 같은 벡터 그래픽을 렌더링하는 그래픽 2D 드로잉 라이브러리
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="모든 플랫폼에서 2D 그래픽 처리" h2="소프트웨어 종속성 없이 벡터 그래픽 및 텍스트 렌더링을 포함하여 2D 도면을 구문 분석하는 기본 API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing.svg" pfName="Aspose.Drawing" downloadUrl="https://downloads.aspose.com/drawing" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-element name="API 참조" href="https://apireference.aspose.com/drawing" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.Drawing 제품군을 선택해야 하는 이유" tabId="success-stories" >}}
