---
title: Vytvořte textový obrazový soubor pomocí .NET
weight: 20
url: /cs/net/renderText/
description: Vytvořte textový obrazový soubor pomocí .NET.
Keywords: create Text via C#, 2D graphics, drawing API, create bitmap C#, Drawing pro .NET, save bitmap, save Text image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Text image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte textový obrazový soubor pomocí C#" h2="Sestavte si své vlastní aplikace .NET pro kreslení pomocí textových obrazových souborů" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pro .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření textu přes C#" %}}
...
+ Vytvořte štětec pro text.
+ Vytvořte pero pro kreslení.
+ Vytvořte písmo a nastavte styl písma.
+ Vytvořte textový řetězec.
+ Vytvořte obdélník pro dekoraci.
+ Kreslit prvky.
...
{{% blocks/products/pf/agp/code-block title="Vytvořit textový obrazový soubor - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Zpracování textu prostřednictvím bezplatné online aplikace" sectionDescription="Vytvářejte textové obrázky a přidávejte text k obrázkům na našem [webu s živými ukázkami](https://products.aspose.app/drawing) Živé demo má následující výhody:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Okamžitě získejte odkaz ke stažení výsledného textového souboru" >}}
