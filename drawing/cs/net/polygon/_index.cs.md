---
title: Vytvořte soubor obrázku Polygon pomocí .NET
weight: 20
url: /cs/net/polygon/
description: Vytvořte soubor obrázku Polygon pomocí .NET.
Keywords: create Polygon via C#, 2D graphics, drawing API, create bitmap C#, Drawing pro .NET, save bitmap, save Polygon image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Polygon image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte soubor obrázku Polygon pomocí C#" h2="Sestavte si své vlastní aplikace .NET pro kreslení pomocí obrazových souborů Polygon" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pro .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pro .NET" >}}


{{% blocks/products/pf/agp/content h2="Jak vytvořit soubor obrázku polygonu pomocí C#" %}}

Objevte jednoduchost vytváření obrazových souborů Polygon pomocí C#. Tento dokument poskytuje základní statistiky a pokyny, ať už jste zkušený vývojář nebo teprve začínáte. Naučte se kroky k bezproblémovému začlenění vytváření obrázků Polygon do vašich projektů a zdokonalte své programovací dovednosti. K vytvoření souborů Polygon použijeme knihovnu [Aspose.Drawing pro .NET](https://products.aspose.com/drawing/net), což je funkčně bohaté, výkonné a snadno použitelné rozhraní API pro kreslení 2D grafiky pro C#. platforma. Otevřete správce balíčků [NuGet](https://www.nuget.org/packages/aspose.drawing), seKřivkah pro **Aspose.Drawing** a nainstalujte. Můžete také použít následující příkaz z konzoly Správce balíčků.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření polygonu přes C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vytvořit soubor obrázku polygonu - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Zpracujte polygon prostřednictvím bezplatné online aplikace" sectionDescription="Vytvářejte obrázky Polygon a přidávejte k obrázkům text na našem [webu s živými ukázkami](https://products.aspose.app/drawing) Živé demo má následující výhody:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Okamžitě získejte odkaz ke stažení výsledného polygonového souboru" >}}
