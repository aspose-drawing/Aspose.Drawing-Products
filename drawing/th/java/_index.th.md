...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.Drawing สำหรับ Java รองรับ [รูปแบบภาพ](https://docs.aspose.com/drawing/net/supported-file-formats/) ต่อไปนี้" >}}
...
<p class="col-lg-10">กำลังเรนเดอร์ of Curves Adjustment Layers</p>
...
<p class="col-lg-10">Adding and กำลังเรนเดอร์ of Level Layers</p>
...
<li>กำลังเรนเดอร์ of Stroke effect with Color Fill for export</li>
