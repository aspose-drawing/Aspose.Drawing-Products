---
title: .NET経由でPNG画像ファイルに画像を追加
weight: 20
url: /ja/net/edit-image/add-image/png/
description: .NET 経由で PNG 画像ビットマップに画像を追加します。
keywords: add image to bitmap, add image to PNG, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing .NET用, save bitmap, save PNG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, PNG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# 経由で PNG 画像ビットマップに画像を追加" h2="PNG 画像の変換: .NET 描画 API を使用した画像の追加" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET用" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName=".NET用" >}}


{{% blocks/products/pf/agp/content h2="C# を使用して既存の PNG 画像ファイルに新しい画像を追加する方法" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
を使用して追加の画像をシームレスに統合することで、PNG の画像を向上させます。 <a href="https://products.aspose.com/drawing/net">Aspose.Drawing用.NET用</a> 多用途な API。この強力なツールは、ビジュアルを強化するためのシンプルかつ効果的な方法を提供します。 Bitmap クラスとラスター グラフィックス描画の機能を利用することで、PNG ファイルに画像を簡単に組み込むことができます。ラスター イメージを操作する場合でも、PNG 形式でファイルを保存する場合でも、Drawing API は比類のない柔軟性と効率性を提供します。 .NET の Drawing API を使用して PNG ファイルに画像を追加する便利さを体験し、画像編集プロジェクトの新たな可能性を今すぐ解き放ってください。開ける <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> パッケージマネージャーを開き、次を検索します <b>Aspose.Drawing</b> そしてインストールします。パッケージ マネージャー コンソールから次のコマンドを使用することもできます。</p>
...
{{% blocks/products/pf/agp/feature-section-col title="C# 経由で PNG 画像に画像を追加する手順" %}}
...
+ `Bitmap`クラスを使用して、PNG画像ファイルからビットマップオブジェクトを作成します。
...
{{% blocks/products/pf/agp/code-block title="PNG 画像ファイルに画像を追加 - C#" offSpacer="" %}}
