---
title: Crear archivo de imagen de pincel a través de .NET
weight: 20
url: /es/net/brush/gradient
description: Cree un archivo de imagen de pincel a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear un pincel mediante C#" %}}
...
+ Crea un pincel con color central.
+ Crea una variedad de colores envolventes.
+ Establecer colores envolventes para cepillar.
+ Dibujar elementos gráficos de curvas.
...
{{% blocks/products/pf/agp/code-block title="Crear archivo de imagen de pincel de degradado - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Procese el pincel a través de la aplicación en línea gratuita" sectionDescription="Cree imágenes de Brush y agregue texto a las imágenes visitando nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenga instantáneamente el enlace de descarga para el archivo Brush resultante" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/solid" name="cepillo sólido" description="Imagen de gráficos de red portátiles con pincel degradado" >}}
