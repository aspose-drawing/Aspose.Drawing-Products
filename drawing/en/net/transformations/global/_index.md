...
{{% blocks/products/pf/agp/feature-section-col title="Steps to transform via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Make global transformation to Image File - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Process global transformation via Free Online App" sectionDescription="Make transformed images, as well as add text to images by visiting our [Live Demos website](https://products.aspose.app/drawing) The live demo has the following benefits:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Instantly get the download link for the resulting Alpha blending file" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/transformation/global/" name="Global" description="Global transformed Portable Network Graphics Picture" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/net/transformation/local/" name="Local" description="Local transformed Portable Network Graphics Picture" >}}
