---
title: .NET aracılığıyla Poligon görüntü dosyası oluşturun
weight: 20
url: /tr/net/polygon/
description: .NET aracılığıyla Poligon görüntü dosyası oluşturun.
Keywords: create Çokgen via C#, 2D graphics, drawing API, create bitmap C#, Drawing .NET için, save bitmap, save Çokgen image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Çokgen image file
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak Çokgen Görüntü Dosyası Nasıl Oluşturulur" %}}

C# ile Çokgen görüntü dosyaları oluşturmanın basitliğini keşfedin. Bu belge, ister deneyimli bir geliştirici olun ister yeni başlıyor olun, temel bilgiler ve rehberlik sağlar. Poligon görüntü oluşturmayı projelerinize sorunsuz bir şekilde dahil etme ve programlama becerilerinizi geliştirme adımlarını öğrenin. Poligon dosyaları oluşturmak amacıyla, C# için zengin özelliklere sahip, güçlü ve kullanımı kolay bir 2D grafik çizim API'si olan [.NET için Aspose.Drawing](https://products.aspose.com/drawing/net) kitaplığını kullanacağız. platformu. **Aspose.Drawing** için [NuGet](https://www.nuget.org/packages/aspose.drawing) paket yöneticisini, seCurveh'i açın ve yükleyin. Aşağıdaki komutu Paket Yönetici Konsolundan da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C# ile Çokgen Oluşturma Adımları" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ücretsiz Çevrimiçi Uygulamayla Poligonu İşleyin" sectionDescription="[Canlı Demolar web sitemizi](https://products.aspose.app/drawing) ziyaret ederek Çokgen görseller oluşturun ve görsellere metin ekleyin. Canlı demo aşağıdaki avantajlara sahiptir:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Ortaya çıkan Çokgen dosyası için indirme bağlantısını anında alın" >}}
