---
title: قم بإنشاء ملف صورة قوس عبر .NET
weight: 20
url: /ar/net/arcs/
description: قم بإنشاء ملف صورة قوس عبر .NET.
keywords: create قوس via C#, 2D graphics, drawing API, create bitmap C#, Drawing ل .NET, save bitmap, save قوس image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, قوس image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء قوس عبر C#" %}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="احصل على رابط التنزيل لملف قوس الناتج على الفور" >}}
