---
title: Přidejte obrázek do souboru obrázku JPEG přes .NET
weight: 20
url: /cs/net/edit-image/add-image/jpeg/
description: Přidejte obrázek do bitmapy obrázku JPEG přes .NET.
keywords: add image to bitmap, add image to JPEG, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing pro .NET, save bitmap, save JPEG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, JPEG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Přidejte obrázek do bitmapy obrázku JPEG přes C#" h2="Transformace obrázků JPEG: Přidejte obrázky pomocí rozhraní API pro kreslení .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pro .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pro .NET" >}}


{{% blocks/products/pf/agp/content h2="Jak přidat nový obrázek do existujícího souboru obrázku JPEG pomocí C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Vylepšete své snímky JPEG bezproblémovou integrací dalších snímků pomocí <a href="https://products.aspose.com/drawing/net">Aspose.Drawing pro .NET</a> všestranné API. Tento výkonný nástroj poskytuje jednoduchý, ale účinný způsob, jak vylepšit vaše vizuální prvky. Využitím možností třídy Bitmap a kreslení rastrové grafiky můžete bez námahy začlenit obrázky do souborů JPEG. Ať už pracujete s rastrovými obrázky nebo ukládáte soubory ve formátu JPEG, rozhraní Drawing API nabízí bezkonkurenční flexibilitu a efektivitu. Vyzkoušejte pohodlí přidávání obrázků do souborů JPEG pomocí rozhraní Drawing API .NET a odemkněte nové možnosti pro své projekty úprav obrázků již dnes. OTEVŘENO <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> správce balíčků a vyhledejte <b>Aspose.Drawing</b> a nainstalovat. Můžete také použít následující příkaz z konzoly Správce balíčků.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k přidání obrázku do obrázku JPEG přes C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Přidat obrázek do souboru obrázku JPEG – C#" offSpacer="" %}}
