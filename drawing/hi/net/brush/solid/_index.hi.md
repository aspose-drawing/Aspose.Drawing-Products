...
{{% blocks/products/pf/agp/code-block title="सॉलिड ब्रश इमेज फ़ाइल बनाएं - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/gradient" name="ग्रेडियेंट ब्रश" description="ग्रेडिएंट ब्रश पोर्टेबल नेटवर्क ग्राफ़िक्स चित्र" >}}
