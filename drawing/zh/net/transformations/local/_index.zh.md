...
title: 通过.NET转换图像文件
weight: 20
url: /zh/net/transformation/local
...
{{% blocks/products/pf/agp/code-block title="对图像文件进行本地转换 - C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-Transformation当地的.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="通过免费在线应用程序进行本地转换" sectionDescription="通过访问我们的[实时演示网站](https://products.aspose.app/drawing)制作转换后的图像，以及向图像添加文本。实时演示具有以下优点：" >}}
