---
title: Eliminar fondo de BMP a través de .NET
weight: 20
url: /es/net/edit-image/remove-background/bmp/
description: Eliminación del fondo del archivo de imagen BMP a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para eliminar el fondo de la imagen BMP mediante C#" %}}
...
+ Guarde el mapa de bits editado en un archivo de formato de imagen BMP.
...
{{% blocks/products/pf/agp/code-block title="Eliminar el fondo del archivo de imagen BMP - C#" offSpacer="" %}}
