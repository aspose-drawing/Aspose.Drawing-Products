---
title: สร้างไฟล์ภาพ เส้น ด้วย .NET
weight: 20
url: /th/net/lines/
description: สร้างไฟล์ภาพ เส้น ด้วย .NET
keywords: create เส้น via C#, 2D graphics, drawing API, create bitmap C#, Drawing สำหรับ .NET, save bitmap, save เส้น image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, เส้น image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ภาพ เส้น ด้วย C#" h2="สร้างแอพพลิเคชั่น .NET ที่คุณกำหนดเองสำหรับการวาดภาพด้วยไฟล์รูปภาพ Line" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีสร้างไฟล์ภาพเส้นโดยใช้ C#" %}}

ค้นพบความเรียบง่ายของการสร้างไฟล์ภาพ เส้น ด้วย C# เอกสารนี้ให้ข้อมูลเชิงลึกและคำแนะนำที่สำคัญ ไม่ว่าคุณจะเป็นนักพัฒนาที่มีประสบการณ์หรือเพิ่งเริ่มต้น เรียนรู้ขั้นตอนในการรวมการสร้างภาพเส้นเข้ากับโปรเจ็กต์ของคุณได้อย่างราบรื่น และเพิ่มทักษะการเขียนโปรแกรมของคุณ ในการสร้างไฟล์ เส้น เราจะใช้ไลบรารี [Aspose.Drawing สำหรับ .NET](https://products.aspose.com/drawing/net) ซึ่งเป็น API การวาดภาพกราฟิก 2D ที่มีคุณสมบัติหลากหลาย ทรงพลัง และใช้งานง่ายสำหรับ C# แพลตฟอร์ม. เปิดตัวจัดการแพ็คเกจ [นูเก็ต](https://www.nuget.org/packages/aspose.drawing) ค้นหา **Aspose.Drawing** และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการสร้างไลน์ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="สร้างไฟล์ภาพเส้น - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="สายการผลิตผ่านแอปออนไลน์ฟรี" sectionDescription="สร้างรูปภาพเส้น รวมถึงเพิ่มข้อความลงในรูปภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีประโยชน์ดังต่อไปนี้:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="รับลิงค์ดาวน์โหลดไฟล์ เส้น ที่ได้ทันที" >}}
