---
title: Créer un fichier image Polygone via .NET
weight: 20
url: /fr/net/polygon/
description: Créez un fichier image Polygone via le .NET.
Keywords: create Polygone via C#, 2D graphics, drawing API, create bitmap C#, Drawing pour .NET, save bitmap, save Polygone image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Polygone image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un polygone via C#" %}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenez instantanément le lien de téléchargement du fichier Polygone résultant" >}}
