---
title: Créer un fichier image de ligne via le .NET
weight: 20
url: /fr/net/lines/
description: Créez un fichier image de ligne via le .NET.
keywords: create Doubler via C#, 2D graphics, drawing API, create bitmap C#, Drawing pour .NET, save bitmap, save Doubler image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Doubler image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier image de ligne via le C#" h2="Créez vos applications .NET personnalisées pour dessiner avec des fichiers image Line." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer une ligne via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image de ligne - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ligne de traitement via une application en ligne gratuite" sectionDescription="Créez des images de ligne et ajoutez du texte aux images en visitant notre [site Web de démonstrations en direct](https://products.aspose.app/drawing). La démo en direct présente les avantages suivants :" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenez instantanément le lien de téléchargement du fichier Doubler résultant" >}}
