---
title: สร้างไฟล์ภาพสี่เหลี่ยมผืนผ้าด้วย .NET
weight: 20
url: /th/net/rectangle/
description: สร้างไฟล์ภาพสี่เหลี่ยมผืนผ้าด้วย .NET
Keywords: create สี่เหลี่ยมผืนผ้า via C#, 2D graphics, drawing API, create bitmap C#, Drawing สำหรับ .NET, save bitmap, save สี่เหลี่ยมผืนผ้า image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, สี่เหลี่ยมผืนผ้า image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ภาพสี่เหลี่ยมผืนผ้าด้วย C#" h2="สร้างแอปพลิเคชัน .NET ที่คุณกำหนดเองสำหรับการวาดภาพด้วยไฟล์ภาพสี่เหลี่ยมผืนผ้า" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีสร้างไฟล์ภาพสี่เหลี่ยมผืนผ้าโดยใช้ C#" %}}

ค้นพบความเรียบง่ายของการสร้างไฟล์ภาพสี่เหลี่ยมผืนผ้าด้วย C# เอกสารนี้ให้ข้อมูลเชิงลึกและคำแนะนำที่สำคัญ ไม่ว่าคุณจะเป็นนักพัฒนาที่มีประสบการณ์หรือเพิ่งเริ่มต้น เรียนรู้ขั้นตอนในการรวมการสร้างภาพสี่เหลี่ยมผืนผ้าเข้ากับโปรเจ็กต์ของคุณได้อย่างราบรื่น และเพิ่มทักษะการเขียนโปรแกรมของคุณ ในการสร้างไฟล์สี่เหลี่ยมผืนผ้า เราจะใช้ไลบรารี [Aspose.Drawing สำหรับ .NET](https://products.aspose.com/drawing/net) ซึ่งเป็น API การวาดภาพกราฟิก 2D ที่มีคุณสมบัติหลากหลาย ทรงพลัง และใช้งานง่ายสำหรับ C# แพลตฟอร์ม. เปิดตัวจัดการแพ็คเกจ [นูเก็ต](https://www.nuget.org/packages/aspose.drawing) seเส้นโค้งh สำหรับ **Aspose.Drawing** และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการสร้างสี่เหลี่ยมผืนผ้าด้วย C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ประมวลผลสี่เหลี่ยมผืนผ้าผ่านแอปออนไลน์ฟรี" sectionDescription="สร้างภาพสี่เหลี่ยมผืนผ้า รวมถึงเพิ่มข้อความลงในภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีประโยชน์ดังต่อไปนี้:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="รับลิงค์ดาวน์โหลดสำหรับไฟล์สี่เหลี่ยมผืนผ้าที่เป็นผลลัพธ์ทันที" >}}
