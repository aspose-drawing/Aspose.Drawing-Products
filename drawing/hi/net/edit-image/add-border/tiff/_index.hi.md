---
title: .NET के माध्यम से TIFF छवि फ़ाइल में बॉर्डर जोड़ें
weight: 20
url: /hi/net/edit-image/add-border/tiff/
description: .NET के माध्यम से TIFF छवि फ़ाइल में बॉर्डर जोड़ें।
keywords: add border to image, add border to TIFF, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing .NET के लिए, save bitmap, save TIFF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, TIFF image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से TIFF छवि फ़ाइल में बॉर्डर जोड़ें" h2=".NET ड्राइंग एपीआई का उपयोग करके बॉर्डर के साथ TIFF छवियों को बढ़ाएं" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET के लिए" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName=".NET के लिए" >}}


{{% blocks/products/pf/agp/content h2="C# का उपयोग करके TIFF छवि फ़ाइल में बॉर्डर कैसे जोड़ें" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
का उपयोग करके बॉर्डर जोड़कर अपनी TIFF छवियों को आसानी से रूपांतरित करें <a href="https://products.aspose.com/drawing/net">.NET के लिए Aspose.Drawing</a> एपीआई. यह क्रॉस-प्लेटफ़ॉर्म 2डी ग्राफ़िक लाइब्रेरी आपकी छवियों में सीमाओं को सहजता से एकीकृत करने के लिए शक्तिशाली उपकरण प्रदान करती है। Aspose.Drawing API के साथ, आप C# का उपयोग करके अपनी TIFF छवियों के चारों ओर आसानी से बॉर्डर बना सकते हैं। पेशेवर-गुणवत्ता वाले परिणाम प्राप्त करने के लिए बिटमैप क्लास और रैस्टर ग्राफिक्स ड्राइंग क्षमताओं का उपयोग करें। चाहे आप रेखापुंज छवियां प्रस्तुत कर रहे हों या TIFF फ़ाइलें सहेज रहे हों, ड्रॉइंग एपीआई आपके दृश्यों को बढ़ाने के लिए आवश्यक लचीलापन और कार्यक्षमता प्रदान करता है। .NET के एपीआई के साथ TIFF छवियों में बॉर्डर जोड़ने की सुविधा का अनुभव करें और आज ही अपनी छवि संपादन प्रक्रिया को उन्नत करें। खुला <a href="https://www.nuget.org/packages/aspose.drawing">नुगेट</a> पैकेज मैनेजर, और खोजें <b>Aspose.Drawing</b> और इंस्टॉल करें. आप पैकेज मैनेजर कंसोल से निम्न कमांड का भी उपयोग कर सकते हैं।</p>
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से TIFF छवि में बॉर्डर जोड़ने के चरण" %}}
...
+ `बिटमैप` वर्ग का उपयोग करके TIFF छवि फ़ाइल से बिटमैप ऑब्जेक्ट बनाएं।
...
{{% blocks/products/pf/agp/code-block title="TIFF छवि फ़ाइल - C# में बॉर्डर जोड़ें" offSpacer="" %}}
