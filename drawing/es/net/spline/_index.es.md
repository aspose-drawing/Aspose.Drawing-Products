---
title: Cree un archivo de imagen Ranura a través de .NET
weight: 20
url: /es/net/spline/
description: Cree un archivo de imagen Ranura a través de .NET.
keywords: create Ranura via C#, 2D graphics, drawing API, create bitmap C#, Drawing para .NET, save bitmap, save Ranura image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Ranura image file
---
...
{{% blocks/products/pf/agp/content h2="Cómo crear un archivo de imagen spline usyo C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear spline mediante C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Procese Ranura a través de una aplicación gratuita en línea" sectionDescription="Cree imágenes Ranura y agregue texto a las imágenes visityo nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenga instantáneamente el enlace de descarga para el archivo Ranura resultante" >}}
