---
title: Cambia lo sfondo del file immagine JPEG tramite .NET
weight: 20
url: /it/net/edit-image/change-background/jpeg/
description: Modifica dello sfondo dell'immagine per il file JPEG tramite .NET.
keywords: change image background, change JPEG background, change background via C#, 2D graphics, drawing API, edit background in C#, Drawing per .NET, save bitmap, save JPEG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, rendering raster images, JPEG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cambia lo sfondo dell'immagine JPEG tramite C#" h2="Rivitalizza le immagini JPEG: modifica degli sfondi con l'API di disegno .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="per .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per cambiare lo sfondo dell'immagine JPEG tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cambia lo sfondo del file immagine JPEG - C#" offSpacer="" %}}
