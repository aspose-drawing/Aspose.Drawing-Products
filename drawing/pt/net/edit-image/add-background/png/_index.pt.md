...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar plano de fundo à imagem PNG via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar plano de fundo ao arquivo de imagem PNG - C#" offSpacer="" %}}
