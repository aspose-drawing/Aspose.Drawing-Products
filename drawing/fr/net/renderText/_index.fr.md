---
title: Créer un fichier image texte via .NET
weight: 20
url: /fr/net/renderText/
description: Créez un fichier image texte via le .NET.
Keywords: create Text via C#, 2D graphics, drawing API, create bitmap C#, Drawing pour .NET, save bitmap, save Text image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Text image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier image texte via C#" h2="Créez vos applications .NET personnalisées pour dessiner avec des fichiers image texte" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment créer un fichier image texte à l'aide du C#" %}}

Découvrez la simplicité de création de fichiers image texte avec le C#. Ce document fournit des informations et des conseils essentiels, que vous soyez un développeur chevronné ou débutant. Découvrez les étapes pour intégrer de manière transparente la création d’images texte dans vos projets et améliorer vos compétences en programmation. Afin de créer des fichiers texte, nous utiliserons la bibliothèque [Aspose.Drawing pour .NET](https://products.aspose.com/drawing/net) qui est une API de dessin graphique 2D riche en fonctionnalités, puissante et facile à utiliser pour le C#. plate-forme. Ouvrez le gestionnaire de packages [NuGet](https://www.nuget.org/packages/aspose.drawing), seCourbeh pour **Aspose.Drawing** et installez. Vous pouvez également utiliser la commete suivante à partir de la console Package Manager.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer du texte via C#" %}}
...
+ Créez un pinceau pour le texte.
+ Créez un stylo pour dessiner.
+ Créez une police et définissez fontStyle.
+ Créez une chaîne de texte.
+ Créez un rectangle pour la décoration.
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image texte - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Traiter le texte via une application en ligne gratuite" sectionDescription="Créez des images de texte et ajoutez du texte aux images en visitant notre [site Web de démonstrations en direct](https://products.aspose.app/drawing). La démo en direct présente les avantages suivants :" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenez instantanément le lien de téléchargement du fichier texte résultant" >}}
