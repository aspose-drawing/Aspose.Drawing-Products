---
title: Dodaj tekst do BMP poprzez .NET
weight: 20
url: /pl/net/edit-image/add-text/bmp/
description: Dodaj tekst do pliku obrazu BMP, korzystając z biblioteki graficznej .NET
keywords: Dodaj tekst to image, Dodaj tekst to BMP, Dodaj tekst to bitmap, Dodaj tekst via C#, 2D graphics, drawing API, edit bitmap C#, Drawing dla .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw text, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj tekst do plików obrazów BMP za pomocą C#" h2="Ulepsz swoje obrazy BMP: dodawanie tekstu za pomocą interfejsu API rysowania .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="dla .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="dla .NET" >}}


{{% blocks/products/pf/agp/content h2="Jak dodać tekst do pliku obrazu BMP w C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Nadaj zdjęciom BMP profesjonalny charakter, dodając tekst <a href="https://products.aspose.com/drawing/net">Aspose.Drawing dla .NET</a> API. To wszechstronne narzędzie umożliwia płynne dodawanie tekstu do obrazów, niezależnie od tego, czy dodajesz adnotacje, etykietujesz, czy znak wodny. Dzięki interfejsowi API Aspose.Drawing możesz z łatwością rysować tekst na obrazach BMP za pomocą C#. Wykorzystaj możliwości rysowania grafiki rastrowej i klasy Bitmap, aby uzyskać precyzyjne i spersonalizowane wyniki. Doświadcz wygody i elastyczności dodawania tekstu do obrazów BMP dzięki API rysowania .NET i wynieś swoje projekty edycji obrazów na nowy poziom. otwarty <a href="https://www.nuget.org/packages/aspose.drawing">NuGeta</a> menedżer pakietów i wyszukaj <b>Aspose.Drawing</b> i zainstaluj. Możesz także użyć następującego polecenia z konsoli Menedżera pakietów.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać tekst do obrazu BMP za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj tekst do pliku obrazu BMP — C#" offSpacer="" %}}
