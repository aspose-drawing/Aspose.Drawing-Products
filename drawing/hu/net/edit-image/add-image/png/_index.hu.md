---
title: Kép hozzáadása a PNG képfájlhoz a .NET segítségével
weight: 20
url: /hu/net/edit-image/add-image/png/
description: Kép hozzáadása a PNG kép bittérképéhez a .NET segítségével.
keywords: add image to bitmap, add image to PNG, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing .NET-hoz, save bitmap, save PNG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, PNG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kép hozzáadása a PNG kép bittérképéhez a C# segítségével" h2="A PNG képek átalakítása: Adjon hozzá képeket a .NET Rajz API-val" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET-hoz" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName=".NET-hoz" >}}


{{% blocks/products/pf/agp/content h2="Új kép hozzáadása a meglévő PNG képfájlhoz a C# használatával" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Emelje fel PNG képeit a további képek zökkenőmentes integrálásával <a href="https://products.aspose.com/drawing/net">Aspose.Drawing .NET-hez</a> sokoldalú API. Ez a hatékony eszköz egyszerű, de hatékony módot kínál a látvány javítására. A Bitmap osztály és a rasztergrafikus rajz képességeinek kihasználásával könnyedén beillesztheti a képeket a PNG fájljaiba. Akár raszteres képekkel dolgozik, akár PNG formátumban menti a fájlokat, a Drawing API páratlan rugalmasságot és hatékonyságot kínál. Tapasztalja meg a .NET Rajz API-jával a PNG fájlokhoz való képek hozzáadásának kényelmét, és tárjon fel új lehetőségeket képszerkesztési projektjei számára még ma. Nyisd ki <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> csomagkezelő, és keressen rá <b>Aspose.Drawing</b> és telepítse. A következő parancsot is használhatja a Package Manager konzolból.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="A kép hozzáadása a PNG képhez a C# segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="Kép hozzáadása a PNG képfájlhoz - C#" offSpacer="" %}}
