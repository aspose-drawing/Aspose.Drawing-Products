...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar texto a la imagen GIF a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Agregar texto al archivo de imagen GIF - C#" offSpacer="" %}}
