---
title: สร้างไฟล์ภาพ อาร์ค ด้วย .NET
weight: 20
url: /th/net/arcs/
description: สร้างไฟล์ภาพ อาร์ค ด้วย .NET
keywords: create อาร์ค via C#, 2D graphics, drawing API, create bitmap C#, Drawing สำหรับ .NET, save bitmap, save อาร์ค image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, อาร์ค image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ภาพ อาร์ค ด้วย C#" h2="สร้างแอปพลิเคชัน .NET ที่คุณกำหนดเองสำหรับการวาดภาพด้วยไฟล์ภาพ อาร์ค" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีสร้างไฟล์ภาพ อาร์ค โดยใช้ C#" %}}

ค้นพบความเรียบง่ายของการสร้างไฟล์ภาพ อาร์ค ด้วย C# เอกสารนี้ให้ข้อมูลเชิงลึกและคำแนะนำที่สำคัญ ไม่ว่าคุณจะเป็นนักพัฒนาที่มีประสบการณ์หรือเพิ่งเริ่มต้น เรียนรู้ขั้นตอนในการรวมการสร้างอิมเมจ อาร์ค เข้ากับโปรเจ็กต์ของคุณได้อย่างราบรื่น และเพิ่มทักษะการเขียนโปรแกรมของคุณ ในการสร้างไฟล์ อาร์ค เราจะใช้ไลบรารี [Aspose.Drawing สำหรับ .NET](https://products.aspose.com/drawing/net) ซึ่งเป็น API การวาดภาพกราฟิก 2D ที่มีคุณสมบัติหลากหลาย ทรงพลัง และใช้งานง่ายสำหรับ C# แพลตฟอร์ม. เปิดตัวจัดการแพ็คเกจ [นูเก็ต](https://www.nuget.org/packages/aspose.drawing) ค้นหา **Aspose.Drawing** และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการสร้าง อาร์ค ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="สร้างไฟล์ภาพ อาร์ค - C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-Drawเส้น.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ประมวลผลส่วนโค้งผ่านแอพออนไลน์ฟรี" sectionDescription="สร้างภาพ อาร์ค รวมถึงเพิ่มข้อความลงในภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีข้อดีดังต่อไปนี้:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="รับลิงค์ดาวน์โหลดไฟล์ อาร์ค ที่ได้ทันที" >}}
