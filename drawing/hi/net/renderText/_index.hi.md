...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से टेक्स्ट बनाने के चरण" %}}
...
+ टेक्स्ट के लिए एक ब्रश बनाएं।
+ ड्राइंग के लिए एक पेन बनाएं।
+ एक फ़ॉन्ट बनाएं और फ़ॉन्ट स्टाइल सेट करें।
+ एक टेक्स्ट स्ट्रिंग बनाएं.
+ सजावट के लिए एक आयत बनाएं।
+ तत्व बनाएं।
...
{{% blocks/products/pf/agp/code-block title="टेक्स्ट इमेज फ़ाइल बनाएं - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="नि:शुल्क ऑनलाइन ऐप के माध्यम से टेक्स्ट प्रोसेस करें" sectionDescription="हमारी [लाइव डेमो वेबसाइट](https://products.aspose.app/drawing) पर जाकर टेक्स्ट छवियां बनाएं, साथ ही छवियों में टेक्स्ट जोड़ें। लाइव डेमो के निम्नलिखित लाभ हैं:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="परिणामी टेक्स्ट फ़ाइल के लिए तुरंत डाउनलोड लिंक प्राप्त करें" >}}
