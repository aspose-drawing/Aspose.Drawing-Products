---
title: Thêm viền vào file ảnh BMP qua .NET
weight: 20
url: /vi/net/edit-image/add-border/bmp/
description: Thêm viền vào file ảnh BMP qua .NET.
keywords: add border to image, add border to BMP, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing cho .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Thêm viền vào file ảnh BMP qua C#" h2="Cải thiện hình ảnh BMP có viền bằng API vẽ .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="cho .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="cho .NET" >}}


{{% blocks/products/pf/agp/content h2="Cách thêm viền vào tệp hình ảnh BMP bằng C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Chuyển đổi hình ảnh BMP của bạn một cách dễ dàng bằng cách thêm đường viền bằng cách sử dụng <a href="https://products.aspose.com/drawing/net">Aspose.Drawing cho .NET</a> API. Thư viện đồ họa 2D đa nền tảng này cung cấp các công cụ mạnh mẽ để tích hợp liền mạch các đường viền vào hình ảnh của bạn. Với API Aspose.Drawing, bạn có thể dễ dàng vẽ đường viền xung quanh hình ảnh BMP của mình bằng C#. Sử dụng lớp Bitmap và khả năng vẽ đồ họa raster để đạt được kết quả chất lượng chuyên nghiệp. Cho dù bạn đang hiển thị hình ảnh raster hay lưu tệp BMP, API Vẽ sẽ cung cấp tính linh hoạt và chức năng mà bạn cần để nâng cao hình ảnh của mình. Trải nghiệm sự tiện lợi của việc thêm đường viền cho hình ảnh BMP bằng API của .NET và nâng cao quy trình chỉnh sửa hình ảnh của bạn ngay hôm nay. Mở <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> quản lý gói và tìm kiếm <b>Aspose.Drawing</b> và cài đặt. Bạn cũng có thể sử dụng lệnh sau từ Bảng điều khiển quản lý gói.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước thêm viền vào ảnh BMP qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Thêm viền vào File ảnh BMP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/drawing/net/edit-image/add-border/bmp/" name="BMP" description="Ảnh bitmap" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/drawing/net/edit-image/add-border/gif/" name="GIF" description="Định dạng trao đổi đồ họa" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/drawing/net/edit-image/add-border/jpeg/" name="JPEG" description="Nhóm chuyên gia nhiếp ảnh chung" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/drawing/net/edit-image/add-border/png/" name="PNG" description="Biểu đồ minh họa mạng lưới không dây" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/drawing/net/edit-image/add-border/tiff/" name="TIFF" description="Định dạng hình ảnh được gắn thẻ" >}}
