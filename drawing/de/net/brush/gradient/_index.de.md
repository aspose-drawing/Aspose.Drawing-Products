---
title: Erstellen Sie eine Pinselbilddatei über .NET
weight: 20
url: /de/net/brush/gradient
description: Erstellen Sie eine Pinselbilddatei über .NET.
Keywords: create Brush via C#, 2D graphics, drawing API, create bitmap C#, Drawing für .NET, save bitmap, save Brush image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Brush image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Erstellen Sie eine Verlaufspinsel-Bilddatei über C#" h2="Erstellen Sie Ihre benutzerdefinierten .NET-Anwendungen zum Zeichnen mit Brush-Bilddateien" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="für .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="für .NET" >}}


{{% blocks/products/pf/agp/content h2="So erstellen Sie eine Verlaufspinsel-Bilddatei mit C#" %}}

Entdecken Sie die Einfachheit der Erstellung von Brush-Bilddateien mit C#. Dieses Dokument bietet wichtige Einblicke und Anleitungen, unabhängig davon, ob Sie ein erfahrener Entwickler sind oder gerade erst anfangen. Lernen Sie die Schritte kennen, mit denen Sie die Erstellung von Brush-Bildern nahtlos in Ihre Projekte integrieren und Ihre Programmierkenntnisse verbessern können. Um Brush-Dateien zu erstellen, verwenden wir die Bibliothek [Aspose.Drawing für .NET](https://products.aspose.com/drawing/net), eine funktionsreiche, leistungsstarke und benutzerfreundliche 2D-Grafikzeichnungs-API für C# Plattform. Öffnen Sie den Paketmanager [NuGet](https://www.nuget.org/packages/aspose.drawing), securveh für **Aspose.Drawing** und installieren Sie ihn. Sie können auch den folgenden Befehl über die Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Erstellen eines Pinsels über C#" %}}
...
+ Erstellen Sie einen Pinsel mit mittlerer Farbe.
+ Erstellen Sie eine Reihe von Surround-Farben.
+ Stellen Sie die Umgebungsfarben auf Pinsel ein.
...
{{% blocks/products/pf/agp/code-block title="Erstellen Sie eine Verlaufspinsel-Bilddatei – C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prozesspinsel über kostenlose Online-App" sectionDescription="Erstellen Sie Pinselbilder und fügen Sie Text zu Bildern hinzu, indem Sie unsere [Live-Demos-Website] (https://products.aspose.app/drawing) besuchen. Die Live-Demo bietet die folgenden Vorteile:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Erhalten Sie sofort den Download-Link für die resultierende Brush-Datei" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/solid" name="Solide Bürste" description="Farbverlaufspinsel Tragbares Netzwerkgrafikbild" >}}
