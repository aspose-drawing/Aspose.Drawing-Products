---
title: C# .NET API de dibujo de gráficos 2D - Aspose 
weight: 20
url: /es/net/ 
description: Biblioteca gráfica .NET para dibujar texto, geometrías e imágenes. Motor de gráficos C# 2D con API compatible con System.Drawing.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API .NET para dibujo de gráficos 2D" h2="Biblioteca gráfica 2D completa, multiplataforma y completamente administrada para dibujar texto, geometrías e imágenes con la biblioteca compatible System.Drawing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/drawing/net" >}}
...
<p align="justify">
 Aspose.Drawing para .NET es un motor de dibujo 2D multiplataforma con API compatible con System.Drawing. La biblioteca de dibujos admite la representación de gráficos vectoriales como líneas, curvas y figuras, así como texto en una variedad de fuentes, tamaños y estilos en imágenes rasterizadas. Las imágenes se pueden guardar en todos los formatos gráficos de uso común, incluidos BMP, PNG, JPEG, GIF y TIFF. Aspose.Drawing es una biblioteca .NET pura y no depende de ningún motor de renderizado nativo externo.
</p>
...
{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una descripción general de Aspose.Drawing para la API de .NET." >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.Drawing para .NET es compatible con .NET Framework versión 2.0, .NET Core 2.0 o posterior." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.Drawing para .NET es compatible con lo siguiente [formatos de imagen](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de dibujo .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Características avanzadas de la API de gráficos .NET
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dibujar líneas, curvas, splines y arcos
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Representar texto con diferentes fuentes y estilos
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Use diferentes anchos y estilos de pluma
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Use pinceles sólidos, de textura, degradados y sombreados
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Soporta mezcla alfa y suavizado
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Trabajar con regiones de recorte
    </p>
   </div>
   <div class="col-lg-4">
...
<p class="col-lg-10">Representación of Curves Adjustment Layers</p>
...
<p class="col-lg-10">Adding and Representación of Level Layers</p>
...
<li>Representación of Stroke effect with Color Fill for export</li>
...
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://apireference.aspose.com/drawing/net" >}}
