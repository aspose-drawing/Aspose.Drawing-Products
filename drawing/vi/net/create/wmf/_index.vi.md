---
title: Tạo file ảnh WMF qua .NET
weight: 20
url: /vi/net/create/wmf/
description: Tạo file ảnh WMF qua .NET.
keywords: create WMF via C#, 2D graphics, drawing API, create metafile C#, Drawing cho .NET, save WMF image file, cross-platform 2D graphic library, Metafile class, vector graphics drawing, draw line, WMF image file, Graphics file formats
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tạo file ảnh WMF qua C#" h2="Xây dựng các ứng dụng .NET tùy chỉnh của bạn để vẽ bằng các tệp hình ảnh WMF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="cho .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="cho .NET" >}}


{{% blocks/products/pf/agp/content h2="Cách tạo file ảnh WMF bằng C#" %}}

Khám phá sự dễ dàng của việc tạo tệp hình ảnh WMF bằng C#. Hướng dẫn này cung cấp những hiểu biết và hướng dẫn quan trọng, phục vụ cho cả nhà phát triển cấp cao cũng như người mới bắt đầu. Kiểm tra các bước để tích hợp dễ dàng việc tạo hình ảnh WMF vào dự án của bạn, nâng cao kỹ năng lập trình của bạn. Để tạo tệp WMF, chúng tôi sẽ sử dụng thư viện [Aspose.Drawing cho .NET](https://products.aspose.com/drawing/net) là thư viện API vẽ đồ họa 2D giàu tính năng, mạnh mẽ và dễ sử dụng cho C# nền tảng. Mở trình quản lý gói [NuGet](https://www.nuget.org/packages/aspose.drawing), tìm kiếm **Aspose.Drawing** và cài đặt. Bạn cũng có thể sử dụng lệnh sau từ Bảng điều khiển quản lý gói.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tạo WMF qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tạo File Ảnh WMF - C#" offSpacer="" %}}
...
Các tệp có phần mở rộng WMF đại diện cho việc lưu trữ dữ liệu hình ảnh định dạng vector cũng như bitmap. Nói chính xác hơn, WMF thuộc danh mục định dạng tệp vector của các định dạng tệp Đồ họa độc lập với thiết bị.
