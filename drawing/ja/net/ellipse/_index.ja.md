...
{{% blocks/products/pf/agp/feature-section-col title="C# 経由で楕円を作成する手順" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="無料オンラインアプリで楕円を加工" sectionDescription="[ライブ デモ Web サイト](https://products.aspose.app/drawing) にアクセスして、楕円画像を作成したり、画像にテキストを追加したりできます。 ライブ デモには、次の利点があります。" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="結果の楕円ファイルのダウンロード リンクを即座に取得します。" >}}
