---
title: 透過.NET為TIFF影像檔案新增邊框
weight: 20
url: /zh-hant/net/edit-image/add-border/tiff/
description: 透過.NET為TIFF影像檔案新增邊框。
keywords: add border to image, add border to TIFF, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing 適用於 .NET, save bitmap, save TIFF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, TIFF image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過C#為TIFF影像檔案新增邊框" h2="使用 .NET 繪圖 API 增強 TIFF 影像的邊框" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="適用於 .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="適用於 .NET" >}}


{{% blocks/products/pf/agp/content h2="如何使用 C# 為 TIFF 影像檔案新增邊框" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
透過使用以下命令新增邊框，輕鬆變換您的 TIFF 影像 <a href="https://products.aspose.com/drawing/net">Aspose.Drawing 換 .NET</a> API。這個跨平台的 2D 圖形庫提供了強大的工具，可以將邊框無縫整合到圖像中。透過 Aspose.Drawing API，您可以使用 C# 輕鬆在 TIFF 影像周圍繪製邊框。利用點陣圖類別和光柵圖形繪製功能來實現專業品質的結果。無論您是渲染光柵影像還是保存 TIFF 文件，繪圖 API 都能提供增強視覺效果所需的靈活性和功能。立即體驗使用 .NET 的 API 為 TIFF 影像新增邊框的便利，並提升您的影像編輯流程。打開 <a href="https://www.nuget.org/packages/aspose.drawing">努格特</a> 套件管理器，然後搜尋 <b>Aspose.Drawing</b> 並安裝。您也可以從套件管理器控制台使用以下命令。</p>
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 為 TIFF 影像新增邊框的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="新增邊框到 TIFF 影像檔案 - C#" offSpacer="" %}}
