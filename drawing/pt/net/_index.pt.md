...
weight: 20
url: /pt/net/ 
description: Biblioteca gráfica .NET para desenho de texto, geometrias e imagens. Motor gráfico C# 2D com API compatível com System.Drawing.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="APIs .NET para desenho gráfico 2D" h2="Biblioteca gráfica 2D completa, multiplataforma e totalmente gerenciada para desenho de texto, geometrias e imagens com biblioteca compatível com System.Drawing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/drawing/net" >}}
...
<p align="justify">
 Aspose.Drawing para .NET é um mecanismo de desenho 2D multiplataforma com API compatível com System.Drawing. A biblioteca de desenho suporta a renderização de gráficos vetoriais, como linhas, curvas e figuras, bem como texto em uma variedade de fontes, tamanhos e estilos em imagens raster. As imagens podem ser salvas em todos os formatos gráficos comumente usados, incluindo BMP, PNG, JPEG, GIF e TIFF. Aspose.Drawing é uma biblioteca .NET pura e não depende de nenhum mecanismo de renderização nativo externo.
</p>
...
{{< blocks/products/pf/carousel-item h3="Num relance" description="Uma visão geral do Aspose.Drawing para .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Independência da plataforma" description="Aspose.Drawing para .NET suporta .NET Framework versão 2.0, .NET Core 2.0 ou posterior." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="APIs de manipulação de desenho" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.Drawing for .NET suporta o seguinte [formatos de imagem](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de desenho .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Recursos avançados da API de gráficos .NET
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Processe e desenhe caminhos gráficos
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Use pincéis sólidos, textura, gradiente e hachura
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Renderização of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Drawing for .NET permite desenhar diferentes gráficos vetoriais, como arcos, Cardinal Spline, Bezier spline, elipses, curvas fechadas, linhas e vários outros tipos. Apenas algumas linhas de código necessárias para desenhar diferentes tipos de gráficos vetoriais usando a API. por exemplo, aqui está o código para desenhar o arco.
    </p>
...
{{< blocks/products/pf/slr-element name="Referências de API" href="https://apireference.aspose.com/drawing/net" >}}
