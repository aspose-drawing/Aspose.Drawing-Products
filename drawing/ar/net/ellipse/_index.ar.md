---
title: إنشاء ملف صورة القطع الناقص عبر .NET
weight: 20
url: /ar/net/ellipse/
description: إنشاء ملف صورة القطع الناقص عبر .NET.
Keywords: create القطع الناقص via C#, 2D graphics, drawing API, create bitmap C#, Drawing ل .NET, save bitmap, save القطع الناقص image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, القطع الناقص image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء القطع الناقص عبر C#" %}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="احصل على رابط التنزيل لملف القطع الناقص الناتج على الفور" >}}
