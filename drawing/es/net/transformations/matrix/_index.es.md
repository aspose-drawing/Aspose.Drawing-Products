...
weight: 20
url: /es/net/transformation/matrix
...
{{% blocks/products/pf/agp/code-block title="Realizar transformación matricial a archivo de imagen - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Transformación de matriz de procesos a través de una aplicación gratuita en línea" sectionDescription="Cree imágenes transformadas y agregue texto a las imágenes visitando nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
