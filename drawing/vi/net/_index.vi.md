---
title: API vẽ đồ họa 2D C# .NET - Aspose 
weight: 20
url: /vi/net/ 
description: Thư viện đồ họa .NET để vẽ văn bản, hình học và hình ảnh. Công cụ đồ họa C# 2D với API tương thích System.Drawing.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Các API .NET cho Bản vẽ Đồ họa 2D" h2="Được quản lý hoàn toàn, đa nền tảng, thư viện đồ họa 2D hoàn chỉnh để vẽ văn bản, hình học và hình ảnh với thư viện tương thích System.Drawing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/drawing/net" >}}
...
<p align="justify">
 Aspose.Drawing for .NET là công cụ vẽ 2D đa nền tảng với API tương thích System.Drawing. Thư viện bản vẽ hỗ trợ kết xuất đồ họa vector như đường thẳng, đường cong và hình cũng như văn bản với nhiều phông chữ, kích thước và kiểu khác nhau trên hình ảnh raster. Hình ảnh có thể được lưu ở tất cả các định dạng đồ họa thường được sử dụng bao gồm BMP, PNG, JPEG, GIF và TIFF. Aspose.Drawing là một thư viện .NET thuần túy và không dựa trên bất kỳ công cụ kết xuất gốc bên ngoài nào.
</p>
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.Drawing cho .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Aspose.Drawing for .NET hỗ trợ .NET Framework phiên bản 2.0, .NET Core 2.0 trở lên." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API thao tác vẽ" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Aspose.Drawing cho .NET hỗ trợ những điều sau [định dạng hình ảnh](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Tính năng API đồ họa .NET nâng cao
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Tạo bitmap từ đầu hoặc tải các tệp hiện có
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Vẽ đường thẳng, đường cong, splines và vòng cung
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Kết xuất văn bản với các phông chữ và kiểu khác nhau
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Sử dụng các loại cọ solid, texture, gradient và hatch
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Kết xuất of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Drawing for .NET cho phép vẽ các đồ họa vector khác nhau như cung tròn, đường cong Cardinal, đường cong Bezier, hình elip, đường cong khép kín, đường thẳng và một số kiểu khác. Chỉ cần vài dòng mã để vẽ các loại đồ họa vector khác nhau bằng cách sử dụng API. Ví dụ: đây là mã để vẽ vòng cung.
    </p>
...
{{< blocks/products/pf/slr-element name="Tham chiếu API" href="https://apireference.aspose.com/drawing/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao nên dùng Aspose.Drawing cho .NET?" tabId="success-stories" >}}
