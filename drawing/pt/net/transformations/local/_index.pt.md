...
weight: 20
url: /pt/net/transformation/local
...
{{% blocks/products/pf/agp/code-block title="Faça transformação local para arquivo de imagem - C#" offSpacer="" %}}
