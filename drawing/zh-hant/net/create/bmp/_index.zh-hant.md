...
keywords: create BMP via C#, 2D graphics, drawing API, create bitmap C#, Drawing 適用於 .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過C#建立BMP鏡像文件" h2="建立您的自訂 .NET 應用程序，用於使用 BMP 映像檔進行繪圖" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="適用於 .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 創建 BMP 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="建立 BMP 影像檔案 - C#" offSpacer="" %}}
