---
title: Créer un fichier image rectangulaire via .NET
weight: 20
url: /fr/net/rectangle/
description: Créez un fichier image rectangulaire via le .NET.
Keywords: create Rectangle via C#, 2D graphics, drawing API, create bitmap C#, Drawing pour .NET, save bitmap, save Rectangle image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Rectangle image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier image rectangulaire via C#" h2="Créez vos applications .NET personnalisées pour dessiner avec des fichiers image rectangulaires" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment créer un fichier image rectangulaire à l'aide du C#" %}}

Découvrez la simplicité de création de fichiers image Rectangle avec le C#. Ce document fournit des informations et des conseils essentiels, que vous soyez un développeur chevronné ou débutant. Découvrez les étapes pour intégrer de manière transparente la création d’images Rectangle dans vos projets et améliorer vos compétences en programmation. Afin de créer des fichiers Rectangle, nous utiliserons la bibliothèque [Aspose.Drawing pour .NET](https://products.aspose.com/drawing/net) qui est une API de dessin graphique 2D riche en fonctionnalités, puissante et facile à utiliser pour C#. plate-forme. Ouvrez le gestionnaire de packages [NuGet](https://www.nuget.org/packages/aspose.drawing), seCourbeh pour **Aspose.Drawing** et installez. Vous pouvez également utiliser la commete suivante à partir de la console Package Manager.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un rectangle via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image rectangulaire - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenez instantanément le lien de téléchargement du fichier Rectangle résultant" >}}
