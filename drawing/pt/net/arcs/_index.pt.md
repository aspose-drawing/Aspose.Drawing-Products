---
title: Criar arquivo de imagem Arco via .NET
weight: 20
url: /pt/net/arcs/
description: Crie um arquivo de imagem Arco via .NET.
keywords: create Arco via C#, 2D graphics, drawing API, create bitmap C#, Drawing para .NET, save bitmap, save Arco image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Arco image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo de imagem Arco via C#" h2="Crie seus aplicativos .NET personalizados para desenhar com arquivos de imagem Arco" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="para .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="para .NET" >}}


{{% blocks/products/pf/agp/content h2="Como criar arquivo de imagem Arco useo C#" %}}

Descubra a simplicidade de criar arquivos de imagem Arco com C#. Este documento fornece informações e orientações essenciais, seja você um desenvolvedor experiente ou apenas iniciante. Aprenda as etapas para incorporar perfeitamente a criação de imagens Arco em seus projetos e aprimorar suas habilidades de programação. Para criar arquivos Arco, usaremos a biblioteca [Aspose.Drawing para .NET](https://products.aspose.com/drawing/net), que é uma API de desenho gráfico 2D rica em recursos, poderosa e fácil de usar para C# plataforma. Abra o gerenciador de pacotes [NuGet](https://www.nuget.org/packages/aspose.drawing), pesquise **Aspose.Drawing** e instale. Você também pode usar o seguinte comeo do Console do Gerenciador de Pacotes.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para criar arco via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Criar arquivo de imagem de arco - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Processar Arco via aplicativo online gratuito" sectionDescription="Crie imagens Arco e adicione texto às imagens visiteo nosso [site de demonstrações ao vivo](https://products.aspose.app/drawing). A demonstração ao vivo tem os seguintes benefícios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenha instantaneamente o link de download do arquivo Arco resultante" >}}
