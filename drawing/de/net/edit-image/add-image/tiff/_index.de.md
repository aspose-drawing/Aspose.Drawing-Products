---
title: Bild über .NET zur TIFF-Bilddatei hinzufügen
weight: 20
url: /de/net/edit-image/add-image/tiff/
description: Bild über .NET zur TIFF-Bildbitmap hinzufügen.
keywords: add image to bitmap, add image to TIFF, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing für .NET, save bitmap, save TIFF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, TIFF image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bild über C# zur TIFF-Bildbitmap hinzufügen" h2="TIFF-Bilder transformieren: Bilder mit der .NET-Zeichnungs-API hinzufügen" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="für .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines Bildes zum TIFF-Bild über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bild zur TIFF-Bilddatei hinzufügen – C#" offSpacer="" %}}
