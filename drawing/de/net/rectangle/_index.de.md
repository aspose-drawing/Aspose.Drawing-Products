---
title: Erstellen Sie eine rechteckige Bilddatei über .NET
weight: 20
url: /de/net/rectangle/
description: Erstellen Sie eine rechteckige Bilddatei über .NET.
Keywords: create Rechteck via C#, 2D graphics, drawing API, create bitmap C#, Drawing für .NET, save bitmap, save Rechteck image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Rechteck image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Erstellen Sie eine rechteckige Bilddatei über C#" h2="Erstellen Sie Ihre benutzerdefinierten .NET-Anwendungen zum Zeichnen mit Rechteck-Bilddateien" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="für .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="für .NET" >}}


{{% blocks/products/pf/agp/content h2="So erstellen Sie eine rechteckige Bilddatei mit C#" %}}

Entdecken Sie die Einfachheit der Erstellung von Rechteck-Bilddateien mit C#. Dieses Dokument bietet wichtige Einblicke und Anleitungen, unabhängig davon, ob Sie ein erfahrener Entwickler sind oder gerade erst anfangen. Lernen Sie die Schritte kennen, mit denen Sie die Erstellung von Rechteckbildern nahtlos in Ihre Projekte integrieren und Ihre Programmierkenntnisse verbessern können. Um Rechteckdateien zu erstellen, verwenden wir die Bibliothek [Aspose.Drawing für .NET](https://products.aspose.com/drawing/net), eine funktionsreiche, leistungsstarke und benutzerfreundliche 2D-Grafikzeichnungs-API für C# Plattform. Öffnen Sie den Paketmanager [NuGet](https://www.nuget.org/packages/aspose.drawing), securveh für **Aspose.Drawing** und installieren Sie ihn. Sie können auch den folgenden Befehl über die Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Erstellen eines Rechtecks ​​über C#" %}}
...
+ Erstellen Sie einen Stift zum Zeichnen.
+ Zeichnen Sie Kurvengrafikelemente.
...
{{% blocks/products/pf/agp/code-block title="Erstellen Sie eine rechteckige Bilddatei – C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-DrawRechteck.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Verarbeiten Sie Rechteck über die kostenlose Online-App" sectionDescription="Erstellen Sie rechteckige Bilder und fügen Sie Text zu Bildern hinzu, indem Sie unsere [Live-Demos-Website] (https://products.aspose.app/drawing) besuchen. Die Live-Demo bietet die folgenden Vorteile:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Erhalten Sie sofort den Download-Link für die resultierende Rechteckdatei" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/ellipse/" name="Ellipse" description="Ellipse Tragbare Netzwerkgrafiken-Bild" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/net/rectangle/" name="Rechteck" description="Rechteckiges tragbares Netzwerkgrafikbild" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="/net/polygon/" name="Polygon" description="Polygon Tragbare Netzwerkgrafiken-Bild" >}}
