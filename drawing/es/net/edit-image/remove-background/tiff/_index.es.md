---
title: Eliminar fondo de TIFF a través de .NET
weight: 20
url: /es/net/edit-image/remove-background/tiff/
description: Eliminación del fondo del archivo de imagen TIFF a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para eliminar el fondo de la imagen TIFF mediante C#" %}}
...
+ Guarde el mapa de bits editado en un archivo de formato de imagen TIFF.
...
{{% blocks/products/pf/agp/code-block title="Eliminar el fondo del archivo de imagen TIFF - C#" offSpacer="" %}}
