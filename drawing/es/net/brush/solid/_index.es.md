...
{{% blocks/products/pf/agp/code-block title="Crear archivo de imagen de pincel sólido - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/gradient" name="Pincel degradado" description="Imagen de gráficos de red portátiles con pincel degradado" >}}
