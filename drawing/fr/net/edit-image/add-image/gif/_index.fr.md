---
title: Ajouter une image au fichier image du GIF via le .NET
weight: 20
url: /fr/net/edit-image/add-image/gif/
description: Ajoutez une image au bitmap d'image GIF via le .NET.
keywords: add image to bitmap, add image to GIF, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing pour .NET, save bitmap, save GIF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, GIF image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ajouter une image au bitmap d'image du GIF via le C#" h2="Transformer les images du GIF : ajouter des images avec l'API de dessin du .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment ajouter une nouvelle image au fichier image GIF existant à l'aide du C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Élevez vos images GIF en intégrant de manière transparente des images supplémentaires à l'aide <a href="https://products.aspose.com/drawing/net">Aspose.Drawing pour .NET</a> API polyvalente. Cet outil puissant offre un moyen simple mais efficace d’améliorer vos visuels. En exploitant les capacités de la classe Bitmap et du dessin graphique raster, vous pouvez facilement incorporer des images dans vos fichiers GIF. Que vous travailliez avec des images raster ou enregistriez des fichiers au format GIF, l'API Drawing offre une flexibilité et une efficacité inégalées. Découvrez la commodité de l'ajout d'images aux fichiers GIF avec l'API de dessin du .NET et débloquez dès aujourd'hui de nouvelles possibilités pour vos projets d'édition d'images. Ouvrir <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> gestionnaire de paquets et recherchez <b>Aspose.Drawing</b> et installer. Vous pouvez également utiliser la commande suivante à partir de la console Package Manager.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter une image à l'image du GIF via le C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter une image au fichier image du GIF - C#" offSpacer="" %}}
