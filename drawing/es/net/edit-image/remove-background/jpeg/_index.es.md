---
title: Eliminar fondo de JPEG a través de .NET
weight: 20
url: /es/net/edit-image/remove-background/jpeg/
description: Eliminación del fondo del archivo de imagen JPEG a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para eliminar el fondo de la imagen JPEG mediante C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Eliminar el fondo del archivo de imagen JPEG - C#" offSpacer="" %}}
