---
title: Agregar borde al archivo de imagen TIFF a través de .NET
weight: 20
url: /es/net/edit-image/add-border/tiff/
description: Agregue borde al archivo de imagen TIFF a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar un borde a la imagen TIFF mediante C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Agregar borde al archivo de imagen TIFF - C#" offSpacer="" %}}
