---
title: Ändra bakgrund för BMP-bildfilen via .NET
weight: 20
url: /sv/net/edit-image/change-background/bmp/
description: Ändra bildbakgrund för BMP-fil via .NET.
keywords: change image background, change BMP background, change background via C#, 2D graphics, drawing API, edit background in C#, Drawing för .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ändra bakgrund för BMP-bilden via C#" h2="Återuppliva BMP-bilder: Ändra bakgrunder med .NET Ritnings-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="för .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att ändra bakgrund till BMP-bild via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ändra bakgrund för BMP Image File - C#" offSpacer="" %}}
