...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zur Transformation über C#" %}}
...
+ Suchen Sie den Bereich, der transformiert werden soll.
+ Transformationenoperationen anwenden.
...
{{% blocks/products/pf/agp/code-block title="Führen Sie eine globale Transformation in eine Bilddatei durch – C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Verarbeiten Sie die globale Transformation über die kostenlose Online-App" sectionDescription="Erstellen Sie transformierte Bilder und fügen Sie Text zu Bildern hinzu, indem Sie unsere [Live-Demos-Website] (https://products.aspose.app/drawing) besuchen. Die Live-Demo bietet die folgenden Vorteile:" >}}
