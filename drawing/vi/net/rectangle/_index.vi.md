---
title: Tạo file ảnh chữ nhật qua .NET
weight: 20
url: /vi/net/rectangle/
description: Tạo file ảnh hình chữ nhật qua .NET.
Keywords: create Hình chữ nhật via C#, 2D graphics, drawing API, create bitmap C#, Drawing cho .NET, save bitmap, save Hình chữ nhật image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Hình chữ nhật image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tạo file ảnh chữ nhật qua C#" h2="Xây dựng các ứng dụng .NET tùy chỉnh của bạn để vẽ bằng các tệp hình ảnh Hình chữ nhật" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="cho .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tạo hình chữ nhật qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tạo File Hình Chữ Nhật - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Xử lý hình chữ nhật thông qua ứng dụng trực tuyến miễn phí" sectionDescription="Tạo hình ảnh Hình chữ nhật cũng như thêm văn bản vào hình ảnh bằng cách truy cập [trang web Demo trực tiếp](https://products.aspose.app/drawing) của chúng tôi. Bản demo trực tiếp có những lợi ích sau:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Nhận ngay liên kết tải xuống cho tệp Hình chữ nhật kết quả" >}}
