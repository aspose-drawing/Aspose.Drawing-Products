---
title: Создайте файл изображения кривой через .NET
weight: 20
url: /ru/net/curves/
description: Создайте файл изображения кривой с помощью .NET.
Keywords: create Изгиб via C#, 2D graphics, drawing API, create bitmap C#, Drawing для .NET, save bitmap, save Изгиб image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Изгиб image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по созданию кривой с помощью C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Кривая процесса через бесплатное онлайн-приложение" sectionDescription="Создавайте изображения кривых, а также добавляйте текст к изображениям, посетив наш [веб-сайт Live Demos](https://products.aspose.app/drawing). Живая демонстрация имеет следующие преимущества:" >}}
