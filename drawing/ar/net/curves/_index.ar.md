---
title: إنشاء ملف صورة منحنى عبر .NET
weight: 20
url: /ar/net/curves/
description: إنشاء ملف صورة منحنى عبر .NET.
Keywords: create منحنى via C#, 2D graphics, drawing API, create bitmap C#, Drawing ل .NET, save bitmap, save منحنى image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, منحنى image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء ملف صورة منحنى عبر C#" h2="أنشئ تطبيقات .NET المخصصة للرسم باستخدام ملفات الصور المنحنية" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="ل .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء منحنى عبر C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="منحنى العملية عبر التطبيق المجاني عبر الإنترنت" sectionDescription="قم بإنشاء صور منحنية، بالإضافة إلى إضافة نص إلى الصور من خلال زيارة [موقع العروض التوضيحية المباشرة] (https://products.aspose.app/drawing). يتمتع العرض التجريبي المباشر بالمزايا التالية:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="احصل على رابط التنزيل لملف منحنى الناتج على الفور" >}}
