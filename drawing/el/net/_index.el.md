...
weight: 20
url: /el/net/ 
description: Βιβλιοθήκη γραφικών .NET για σχεδίαση κειμένου, γεωμετριών και εικόνων. Μηχανή γραφικών C# 2D με API συμβατό με System.Drawing.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API για τρισδιάστατα γραφικά" h2="Πλήρης διαχείριση, πολλαπλές πλατφόρμες, πλήρης 2D γραφική βιβλιοθήκη για σχεδίαση κειμένου, γεωμετριών και εικόνων με συμβατή βιβλιοθήκη System.Drawing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/drawing/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Πλατφόρμα Ανεξαρτησίας" description="Το Aspose.Drawing για .NET υποστηρίζει .NET Framework έκδοση 2.0, .NET Core 2.0 ή νεότερη έκδοση." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Υποστηριζόμενες μορφές αρχείων" description="Το Aspose.Drawing για .NET υποστηρίζει τα ακόλουθα [μορφές εικόνας](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="Αναφορές API" href="https://apireference.aspose.com/drawing/net" >}}
