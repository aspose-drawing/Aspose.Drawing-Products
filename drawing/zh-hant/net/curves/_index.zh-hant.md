---
title: 透過.NET建立曲線影像文件
weight: 20
url: /zh-hant/net/curves/
description: 透過.NET建立曲線影像檔。
Keywords: create 曲線 via C#, 2D graphics, drawing API, create bitmap C#, Drawing 適用於 .NET, save bitmap, save 曲線 image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, 曲線 image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過C#建立曲線影像文件" h2="建立您的自訂 .NET 應用程式以使用曲線影像檔案進行繪圖" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="適用於 .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 建立曲線的步驟" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="透過免費線上應用程式繪製工藝曲線" sectionDescription="建立曲線影像，以及透過造訪我們的[即時示範網站](https://products.aspose.app/drawing)為影像新增文字即時示範具有以下優點：" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="立即取得生成的曲線檔案的下載鏈接" >}}
