---
title: Vytvořte soubor obrazu cesty pomocí .NET
weight: 20
url: /cs/net/paths/
description: Vytvořte soubor obrazu cesty pomocí .NET.
Keywords: create Path via C#, 2D graphics, drawing API, create bitmap C#, Drawing pro .NET, save bitmap, save Path image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Path image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte soubor obrazu cesty pomocí C#" h2="Sestavte si své vlastní aplikace .NET pro kreslení pomocí obrazových souborů Path" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pro .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření cesty přes C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vytvořit soubor obrázku cesty - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Cesta procesu prostřednictvím bezplatné online aplikace" sectionDescription="Vytvářejte obrázky cesty a přidávejte k obrázkům text na našem [webu s živými ukázkami](https://products.aspose.app/drawing) Živá ukázka má následující výhody:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Okamžitě získejte odkaz ke stažení výsledného souboru Path" >}}
