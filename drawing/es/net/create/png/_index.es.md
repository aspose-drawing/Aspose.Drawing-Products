...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear PNG a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Crear archivo de imagen PNG - C#" offSpacer="" %}}
