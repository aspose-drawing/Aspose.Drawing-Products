---
title: Fügen Sie über .NET Text zu BMP hinzu
weight: 20
url: /de/net/edit-image/add-text/bmp/
description: Fügen Sie mithilfe der .NET-Grafikbibliothek Text zur BMP-Bilddatei hinzu
keywords: Text hinzufügen to image, Text hinzufügen to BMP, Text hinzufügen to bitmap, Text hinzufügen via C#, 2D graphics, drawing API, edit bitmap C#, Drawing für .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw text, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fügen Sie mit C# Text zu BMP-Bilddateien hinzu" h2="Werten Sie Ihre BMP-Bilder auf: Text hinzufügen mit der .NET-Zeichnungs-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="für .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="für .NET" >}}


{{% blocks/products/pf/agp/content h2="So fügen Sie Text zur BMP-Bilddatei in C# hinzu" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Verleihen Sie Ihren BMP-Bildern eine professionelle Note, indem Sie Text einfügen <a href="https://products.aspose.com/drawing/net">Aspose.Drawing für .NET</a> API. Mit diesem vielseitigen Tool können Sie Ihren Bildern nahtlos Text hinzufügen, unabhängig davon, ob Sie Anmerkungen, Beschriftungen oder Wasserzeichen hinzufügen. Mit der Aspose.Drawing-API können Sie mithilfe von C# ganz einfach Text auf BMP-Bildern zeichnen. Nutzen Sie die Bitmap-Klasse und die Zeichenfunktionen für Rastergrafiken, um präzise und individuelle Ergebnisse zu erzielen. Erleben Sie den Komfort und die Flexibilität des Hinzufügens von Text zu BMP-Bildern mit der Zeichen-API des .NET und bringen Sie Ihre Bildbearbeitungsprojekte auf ein neues Niveau. Offen <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> Paketmanager und suchen Sie nach <b>Aspose.Drawing</b> und installieren. Sie können auch den folgenden Befehl über die Paket-Manager-Konsole verwenden.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen von Text zum BMP-Bild über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Text zur BMP-Bilddatei hinzufügen – C#" offSpacer="" %}}
