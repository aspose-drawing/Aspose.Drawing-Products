...
{{% blocks/products/pf/agp/code-block title="Utwórz plik obrazu pędzla stałego — C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/gradient" name="Pędzel gradientowy" description="Pędzel gradientowy Przenośny obraz graficzny sieciowy" >}}
