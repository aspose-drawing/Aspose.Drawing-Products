...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter un arrière-plan à l'image du GIF via le C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter un arrière-plan au fichier image du GIF - C#" offSpacer="" %}}
