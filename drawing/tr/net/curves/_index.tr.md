---
title: .NET aracılığıyla Eğri görüntü dosyası oluşturun
weight: 20
url: /tr/net/curves/
description: .NET aracılığıyla Eğri görüntü dosyası oluşturun.
Keywords: create Eğri via C#, 2D graphics, drawing API, create bitmap C#, Drawing .NET için, save bitmap, save Eğri image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Eğri image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="C# ile Eğri Oluşturma Adımları" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ücretsiz Çevrimiçi Uygulamayla Süreç Eğrisi" sectionDescription="[Canlı Demolar web sitemizi](https://products.aspose.app/drawing) ziyaret ederek Eğri görselleri oluşturun ve görsellere metin ekleyin. Canlı demo aşağıdaki avantajlara sahiptir:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Ortaya çıkan Eğri dosyasının indirme bağlantısını anında alın" >}}
