...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z obrazu BMP za pomocą C#" %}}
...
+ Zapisz edytowaną mapę bitową w pliku w formacie obrazu BMP.
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z pliku obrazu BMP - C#" offSpacer="" %}}
