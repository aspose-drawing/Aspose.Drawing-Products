---
title: Cree un archivo de imagen Elipse a través de .NET
weight: 20
url: /es/net/ellipse/
description: Cree un archivo de imagen Elipse a través de .NET.
...
{{% blocks/products/pf/agp/content h2="Cómo crear un archivo de imagen de elipse usyo C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear una elipse mediante C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Procese Elipse a través de una aplicación gratuita en línea" sectionDescription="Cree imágenes de Elipse y agregue texto a las imágenes visityo nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenga instantáneamente el enlace de descarga del archivo Elipse resultante" >}}
