---
title: Adicionar borda ao arquivo de imagem GIF via .NET
weight: 20
url: /pt/net/edit-image/add-border/gif/
description: Adicione borda ao arquivo de imagem GIF via .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar borda à imagem GIF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar borda ao arquivo de imagem GIF - C#" offSpacer="" %}}
