...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से ब्रश बनाने के चरण" %}}
...
+ बीच के रंग से एक ब्रश बनाएं।
+ चारों ओर रंगों की सरणी बनाएं।
+ ब्रश करने के लिए चारों ओर के रंग सेट करें।
...
{{% blocks/products/pf/agp/code-block title="ग्रेडिएंट ब्रश इमेज फ़ाइल बनाएं - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="नि:शुल्क ऑनलाइन ऐप के माध्यम से ब्रश की प्रक्रिया करें" sectionDescription="हमारी [लाइव डेमो वेबसाइट](https://products.aspose.app/drawing) पर जाकर ब्रश छवियां बनाएं, साथ ही छवियों में टेक्स्ट जोड़ें। लाइव डेमो के निम्नलिखित लाभ हैं:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="परिणामी ब्रश फ़ाइल के लिए तुरंत डाउनलोड लिंक प्राप्त करें" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/solid" name="ठोस ब्रश" description="ग्रेडिएंट ब्रश पोर्टेबल नेटवर्क ग्राफ़िक्स चित्र" >}}
