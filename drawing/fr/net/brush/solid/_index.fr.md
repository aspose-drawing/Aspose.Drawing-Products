...
+ Créez un pinceau avec de la couleur.
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image de pinceau solide - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/gradient" name="Pinceau dégradé" description="Pinceau dégradé Image graphique réseau portable" >}}
