...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแปลงร่างผ่าน C#" %}}
...
+ ค้นหาพื้นที่เพื่อทำการเปลี่ยนแปลง
+ ใช้การดำเนินการแปลงร่าง
...
{{% blocks/products/pf/agp/code-block title="ทำการเปลี่ยนแปลงทั่วโลกเป็นไฟล์รูปภาพ - C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-Transformationทั่วโลก.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ประมวลผลการเปลี่ยนแปลงระดับโลกผ่านแอปออนไลน์ฟรี" sectionDescription="สร้างภาพที่แปลงแล้ว รวมทั้งเพิ่มข้อความลงในภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีประโยชน์ดังต่อไปนี้:" >}}
