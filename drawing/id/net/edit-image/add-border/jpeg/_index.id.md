---
title: Tambahkan batas ke file gambar JPEG melalui .NET
weight: 20
url: /id/net/edit-image/add-border/jpeg/
description: Tambahkan batas ke file gambar JPEG melalui .NET.
keywords: add border to image, add border to JPEG, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing untuk .NET, save bitmap, save JPEG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, JPEG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tambahkan batas ke file gambar JPEG melalui C#" h2="Sempurnakan Gambar JPEG dengan Batas Menggunakan API Gambar .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="untuk .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="untuk .NET" >}}


{{% blocks/products/pf/agp/content h2="Cara Menambahkan Perbatasan ke File Gambar JPEG Menggunakan C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Ubah gambar JPEG Anda dengan mudah dengan menambahkan batas menggunakan <a href="https://products.aspose.com/drawing/net">Aspose.Drawing untuk .NET</a> API. Pustaka grafis 2D lintas platform ini menawarkan alat canggih untuk mengintegrasikan batas ke dalam gambar Anda dengan mulus. Dengan Aspose.Drawing API, Anda dapat dengan mudah menggambar batas di sekitar gambar JPEG menggunakan C#. Memanfaatkan kemampuan menggambar grafis kelas Bitmap dan raster untuk mencapai hasil berkualitas profesional. Baik Anda merender gambar raster atau menyimpan file JPEG, Drawing API memberikan fleksibilitas dan fungsionalitas yang Anda perlukan untuk menyempurnakan visual Anda. Rasakan kemudahan menambahkan batas pada gambar JPEG dengan API .NET dan tingkatkan proses pengeditan gambar Anda sekarang. Membuka <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> manajer paket, dan cari <b>Aspose.Drawing</b> dan instal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menambahkan batas ke gambar JPEG melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tambahkan batas ke File Gambar JPEG - C#" offSpacer="" %}}
