---
title: .NET के माध्यम से GIF छवि फ़ाइल की पृष्ठभूमि बदलें
weight: 20
url: /hi/net/edit-image/change-background/gif/
description: .NET के माध्यम से GIF फ़ाइल के लिए छवि पृष्ठभूमि बदलना।
keywords: change image background, change GIF background, change background via C#, 2D graphics, drawing API, edit background in C#, Drawing .NET के लिए, save bitmap, save GIF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, rendering raster images, GIF image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से GIF छवि की पृष्ठभूमि बदलें" h2="GIF छवियों को पुनर्जीवित करें: .NET ड्राइंग एपीआई के साथ पृष्ठभूमि बदलना" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET के लिए" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName=".NET के लिए" >}}


{{% blocks/products/pf/agp/content h2="C# का उपयोग करके GIF छवि फ़ाइल की पृष्ठभूमि कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से पृष्ठभूमि को GIF छवि में बदलने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF छवि फ़ाइल - C# की पृष्ठभूमि बदलें" offSpacer="" %}}
