---
title: Crear archivo de imagen de ruta a través de .NET
weight: 20
url: /es/net/paths/
description: Cree un archivo de imagen de ruta a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear una ruta a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Crear archivo de imagen de ruta - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ruta del proceso a través de una aplicación gratuita en línea" sectionDescription="Cree imágenes de ruta y agregue texto a las imágenes visitando nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenga instantáneamente el enlace de descarga para el archivo de ruta resultante" >}}
