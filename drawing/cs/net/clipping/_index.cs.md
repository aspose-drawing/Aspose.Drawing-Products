---
title: Vytvořte soubor s ořezovým obrázkem pomocí .NET
weight: 20
url: /cs/net/clipping/
description: Vytvořte soubor s ořezovým obrázkem pomocí .NET.
Keywords: create Výstřižek via C#, 2D graphics, drawing API, create bitmap C#, Drawing pro .NET, save bitmap, save Výstřižek image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Výstřižek image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte soubor s ořezovým obrázkem pomocí C#" h2="Sestavte si své vlastní aplikace .NET pro kreslení pomocí ořezových obrazových souborů" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pro .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření výstřižku přes C#" %}}
...
+ Nastavit TextVykreslováníHint.
+ Vytvořte hraniční obdélník.
+ Vytvořit cestu klipu.
+ Nastavit ohraničení na klip.
+ Nastavte klip na grafiku.
+ Vytvořte a nastavte textový řetězec.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Proces ořezávání prostřednictvím bezplatné online aplikace" sectionDescription="Vytvářejte výstřižky a přidávejte k obrázkům text na našem [webu s živými ukázkami](https://products.aspose.app/drawing) Živá ukázka má následující výhody:" >}}
