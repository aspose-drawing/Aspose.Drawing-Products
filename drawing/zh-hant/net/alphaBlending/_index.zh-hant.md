---
title: 透過.NET建立Alpha混合圖像文件
weight: 20
url: /zh-hant/net/alphaBlending/
description: 透過 .NET 建立 Alpha 混合圖像檔案。
Keywords: create 阿爾法混合 via C#, 2D graphics, drawing API, create bitmap C#, Drawing 適用於 .NET, save bitmap, save 阿爾法混合 image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, 阿爾法混合 image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過C#建立Alpha混合圖像文件" h2="建立您的自訂 .NET 應用程序，用於使用 Alpha 混合圖像檔案進行繪圖" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="適用於 .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 創建 Alpha 混合的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="建立 Alpha 混合圖像檔案 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="透過免費線上應用程式處理 Alpha 混合" sectionDescription="透過造訪我們的[即時示範網站](https://products.aspose.app/drawing) 建立 Alpha 混合影像，以及新增文字 即時示範有以下優點：" >}}
