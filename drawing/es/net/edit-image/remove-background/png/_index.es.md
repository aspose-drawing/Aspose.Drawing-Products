---
title: Eliminar fondo de PNG a través de .NET
weight: 20
url: /es/net/edit-image/remove-background/png/
description: Eliminación del fondo del archivo de imagen PNG a través de .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para eliminar el fondo de la imagen PNG mediante C#" %}}
...
+ Guarde el mapa de bits editado en un archivo de formato de imagen PNG.
...
{{% blocks/products/pf/agp/code-block title="Eliminar el fondo del archivo de imagen PNG - C#" offSpacer="" %}}
