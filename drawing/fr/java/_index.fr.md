...
keywords: Java API, Java library, Graphic Library, drawing text, drawing les courbes, drawing lines, drawing figures, vector graphics, cross-platform graphics
---
...
<div class="col-lg-12">
   <h3 class="h3title">
   Captivez avec du texte dans différents modèles
   </h3>

   <p align='justify'>
   Démarquez-vous en ajoutant un texte captivant à vos graphiques. Le Aspose.Drawing facilite la manipulation du texte en proposant différentes polices, tailles et modèles. Que vous préfériez un look moderne ou classique, la bibliothèque fournit les outils nécessaires pour donner vie à votre vision.
   </p>
</div>
...
<div class="col-lg-12">
   ...
   <li>
   <b>Texte de narration :</b> Créez des histoires captivantes avec un texte qui en dit long. Avec une large gamme de polices et de modèles, le Aspose.Drawing garantit que votre texte est aussi captivant que vos graphiques.
   </li>
   <li>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulation de dessins Java" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-java.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plateforme" description="Le Aspose.Drawing pour Java prend en charge le JDK 1.8 et supérieur." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
  ...
  <div class="d1-col d1-right">
   <header>
    ...
    Environnement d'exécution du Java
   </header>
   <ul>
    <li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de traitement des dessins Java" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-java.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Restituer le texte avec différentes polices et modèles
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Utilisez différentes largeurs et modèles de stylo
    </p>
   </div>
   <div class="col-lg-4">
