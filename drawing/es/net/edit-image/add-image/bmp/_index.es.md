---
title: Agregar imagen al archivo de imagen BMP a través de .NET
weight: 20
url: /es/net/edit-image/add-image/bmp/
description: Agregue una imagen al mapa de bits de imagen BMP a través de .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="Agregar imagen al mapa de bits de imagen BMP a través de C#" h2="Transforme imágenes BMP: agregue imágenes con la API de dibujo .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="para .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar una imagen a la imagen BMP a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Agregar imagen al archivo de imagen BMP - C#" offSpacer="" %}}
