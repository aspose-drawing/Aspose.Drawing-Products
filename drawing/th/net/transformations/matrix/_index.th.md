...
weight: 20
url: /th/net/transformation/matrix
...
{{% blocks/products/pf/agp/code-block title="ทำการแปลงเมทริกซ์เป็นไฟล์รูปภาพ - C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-Transformationเมทริกซ์.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ประมวลผลการแปลงเมทริกซ์ผ่านแอปออนไลน์ฟรี" sectionDescription="สร้างภาพที่แปลงแล้ว รวมทั้งเพิ่มข้อความลงในภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีประโยชน์ดังต่อไปนี้:" >}}
