...
{{% blocks/products/pf/agp/code-block title="Szilárd ecset képfájl létrehozása - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/gradient" name="Gradiens ecset" description="Gradiens ecset hordozható hálózati grafikai kép" >}}
