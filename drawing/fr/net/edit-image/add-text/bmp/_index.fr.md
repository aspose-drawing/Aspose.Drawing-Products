---
title: Ajouter du texte au BMP via le .NET
weight: 20
url: /fr/net/edit-image/add-text/bmp/
description: Ajouter du texte au fichier image BMP à l'aide de la bibliothèque graphique .NET
keywords: ajouter du texte to image, ajouter du texte to BMP, ajouter du texte to bitmap, ajouter du texte via C#, 2D graphics, drawing API, edit bitmap C#, Drawing pour .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw text, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ajouter du texte aux fichiers image du BMP à l'aide du C#" h2="Élevez vos images BMP : ajout de texte avec l'API de dessin du .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment ajouter du texte au fichier image du BMP dans le C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Donnez à vos images BMP une touche professionnelle en incorporant du texte à l'aide de <a href="https://products.aspose.com/drawing/net">Aspose.Drawing pour .NET</a> API. Cet outil polyvalent vous permet d'ajouter en toute transparence du texte à vos images, que vous annotiez, étiquetiez ou filigraniez. Avec l'API Aspose.Drawing, vous pouvez facilement dessiner du texte sur des images BMP à l'aide du C#. Utilisez la classe Bitmap et les capacités de dessin de graphiques raster pour obtenir des résultats précis et personnalisés. Découvrez la commodité et la flexibilité de l'ajout de texte aux images du BMP avec l'API de dessin du .NET et élevez vos projets d'édition d'images vers de nouveaux sommets. Ouvrir <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> gestionnaire de paquets et recherchez <b>Aspose.Drawing</b> et installer. Vous pouvez également utiliser la commande suivante à partir de la console Package Manager.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter du texte à l'image du BMP via le C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter du texte au fichier image du BMP - C#" offSpacer="" %}}
