...
weight: 20
url: /id/net/ 
description: Pustaka grafis .NET untuk menggambar teks, geometri, dan gambar. Mesin grafis C# 2D dengan API yang kompatibel dengan System.Drawing.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET API untuk Gambar Grafik 2D" h2="Pustaka grafis 2D lengkap yang terkelola sepenuhnya, lintas platform, untuk menggambar teks, geometri, dan gambar dengan pustaka yang kompatibel dengan System.Drawing." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/drawing/net" >}}
...
<p align="justify">
 Aspose.Drawing untuk .NET adalah mesin gambar 2D lintas platform dengan API yang kompatibel dengan System.Drawing. Pustaka gambar mendukung rendering grafik vektor seperti garis, kurva, dan gambar serta teks dalam berbagai font, ukuran, dan gaya ke gambar raster. Gambar dapat disimpan dalam semua format grafik yang umum digunakan termasuk BMP, PNG, JPEG, GIF, dan TIFF. Aspose.Drawing adalah pustaka .NET murni dan tidak bergantung pada mesin rendering asli eksternal apa pun.
</p>
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.Drawing untuk .NET mendukung .NET Framework versi 2.0, .NET Core 2.0 atau yang lebih baru." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.Drawing untuk .NET mendukung yang berikut: [format gambar](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET Menggambar API" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Fitur .NET Graphics API Tingkat Lanjut
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Menggambar garis, kurva, splines dan busur
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Render teks dengan font dan gaya yang berbeda
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gunakan kuas padat, tekstur, gradien, dan menetas
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-element name="Referensi API" href="https://apireference.aspose.com/drawing/net" >}}
