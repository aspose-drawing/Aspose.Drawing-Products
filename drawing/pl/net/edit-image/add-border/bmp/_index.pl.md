...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać obramowanie do obrazu BMP za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj obramowanie do pliku obrazu BMP - C#" offSpacer="" %}}
