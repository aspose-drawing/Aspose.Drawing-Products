---
title: Supprimer l'arrière-plan du PNG via le .NET
weight: 20
url: /fr/net/edit-image/remove-background/png/
description: Suppression de l'arrière-plan du fichier image PNG via .NET.
keywords: remove background from image, remove background from PNG, remove background via C#, background removal, erase background, clean image, 2D graphics, drawing API, edit bitmap C#, Drawing pour .NET, save bitmap, save PNG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, rendering raster images, PNG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Supprimer l'arrière-plan du fichier image PNG via C#" h2="Nettoyer les images PNG avec suppression de l'arrière-plan à l'aide de l'API de dessin .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment supprimer l'arrière-plan du fichier image PNG à l'aide du C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Dévoilez la puissance d’une retouche d’image précise avec <a href="https://products.aspose.com/drawing/net">Aspose.Drawing pour .NET</a> en éliminant sans effort les arrière-plans de vos fichiers image PNG. Que vous recherchiez une finition soignée ou que vous cherchiez à mettre en valeur votre sujet, cet outil dynamique vous permet de réaliser votre vision de manière transparente. Avec notre API .NET, la suppression des arrière-plans des images PNG devient un processus rationalisé. Utilisez les fonctionnalités robustes de notre bibliothèque de dessins pour éditer des bitmaps avec précision, en tirant parti de son API intuitive pour produire des résultats époustouflants. Découvrez l'efficacité et la précision de la suppression de l'arrière-plan avec le .NET et améliorez dès aujourd'hui les capacités d'édition d'images de votre PNG. Ouvrir <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> gestionnaire de paquets et recherchez <b>Aspose.Drawing</b> et installer. Vous pouvez également utiliser la commande suivante à partir de la console Package Manager.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour supprimer l'arrière-plan de l'image PNG via C#" %}}
...
+ Enregistrez le bitmap modifié dans un fichier au format d'image PNG.
...
{{% blocks/products/pf/agp/code-block title="Supprimer l'arrière-plan du fichier image PNG - C#" offSpacer="" %}}
