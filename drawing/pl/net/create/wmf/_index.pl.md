---
title: Utwórz plik obrazu WMF za pomocą .NET
weight: 20
url: /pl/net/create/wmf/
description: Utwórz plik obrazu WMF za pomocą .NET.
keywords: create WMF via C#, 2D graphics, drawing API, create metafile C#, Drawing dla .NET, save WMF image file, cross-platform 2D graphic library, Metafile class, vector graphics drawing, draw line, WMF image file, Graphics file formats
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz plik obrazu WMF za pomocą C#" h2="Twórz własne aplikacje na .NET do rysowania, korzystając z plików obrazów WMF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="dla .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="dla .NET" >}}


{{% blocks/products/pf/agp/content h2="Jak utworzyć plik obrazu WMF za pomocą C#" %}}

Odkryj łatwość generowania plików obrazów WMF przy użyciu C#. Ten przewodnik zawiera istotne informacje i wskazówki, przydatne zarówno starszym programistom, jak i początkującym. Sprawdź, jak łatwo zintegrować tworzenie obrazów WMF ze swoimi projektami, podnosząc swoje umiejętności programowania. Aby utworzyć pliki WMF, użyjemy biblioteki [Aspose.Drawing dla .NET](https://products.aspose.com/drawing/net), która jest bogatym w funkcje, wydajnym i łatwym w użyciu interfejsem API do rysowania grafiki 2D dla C# platforma. Otwórz menedżera pakietów [NuGeta] (https://www.nuget.org/packages/aspose.drawing), wyszukaj **Aspose.Drawing** i zainstaluj. Możesz także użyć następującego polecenia z konsoli Menedżera pakietów.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby utworzyć WMF za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Utwórz plik obrazu WMF - C#" offSpacer="" %}}
...
Pliki z rozszerzeniem WMF służą do przechowywania danych obrazów wektorowych i bitmapowych. Mówiąc dokładniej, WMF należy do kategorii formatów plików wektorowych, obejmującej formaty plików graficznych, niezależnej od urządzenia.
