---
title: REn toevoegen aan JPEG-afbeeldingsbestEn via .NET
weight: 20
url: /nl/net/edit-image/add-border/jpeg/
description: REn toevoegen aan JPEG-afbeeldingsbestEn via .NET.
keywords: add border to image, add border to JPEG, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing voor .NET, save bitmap, save JPEG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, JPEG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="REn toevoegen aan JPEG-afbeeldingsbestEn via C#" h2="Verbeter JPEG-afbeeldingen met rEnen met behulp van de .NET Teken-API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="voor .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="voor .NET" >}}


{{% blocks/products/pf/agp/content h2="REn toevoegen aan JPEG-afbeeldingsbestEn met C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
Transformeer uw JPEG-afbeeldingen eenvoudig door rEnen toe te voegen met behulp van <a href="https://products.aspose.com/drawing/net">Aspose.Drawing voor .NET</a> API. Deze platformonafhankelijke grafische 2D-bibliotheek biedt krachtige tools om rEnen naadloos in uw afbeeldingen te integreren. Met de Aspose.Drawing API kunt u met C# moeiteloos rEnen rond uw JPEG-afbeeldingen tekenen. Maak gebruik van de Bitmap-klasse en de tekenmogelijkheden voor rasterafbeeldingen om resultaten van professionele kwaliteit te bereiken. Of u nu rasterafbeeldingen rendert of JPEG-bestEnen opslaat, de Drawing API biedt de flexibiliteit en functionaliteit die u nodig heeft om uw beelden te verbeteren. Ervaar het gemak van het toevoegen van rEnen aan JPEG-afbeeldingen met de .NET-API en verbeter vEnaag nog uw beeldbewerkingsproces. Open <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> pakketbeheerder en zoek naar <b>Aspose.Drawing</b> en installeren. U kunt ook de volgende opdracht gebruiken vanuit de Package Manager Console.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om een ​​rEn toe te voegen aan de JPEG-afbeelding via de C#" %}}
...
+ Teken een rEn met de methode `DrawRechthoek()`.
...
{{% blocks/products/pf/agp/code-block title="REn toevoegen aan JPEG-afbeeldingsbestEn - C#" offSpacer="" %}}
