---
title: Edit image via .NET
weight: 20
url: /net/edit-image/
description: Editing images with Aspose.Drawing graphic library for .NET (C#) to add image border, text and change or remove background
keywords: edit image in C#, edit image file, bitmap images in C#, graphic library for .NET, add image, add border, add text, add background, change background, remove background
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Edit images with C#" h2="Edit Images via Aspose.Drawing graphic library for .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="for .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    Advanced Image Editing .NET API Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="add-background/">Add background</a>
    </p>
   </div>
   <div class="col-lg-4">
