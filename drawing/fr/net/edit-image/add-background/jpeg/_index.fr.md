...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter un arrière-plan à l'image du JPEG via le C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter un arrière-plan au fichier image du JPEG - C#" offSpacer="" %}}
