...
keywords: create EMF via Java, 2D graphics, drawing API, create metafile in Java, Drawing pour Java, save EMF image file, cross-platform 2D graphic library, Metafile class, vector graphics drawing, draw line, EMF image file, Graphics file formats
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utilisez le Java pour créer des fichiers image EMF" h2="Améliorez les capacités de vos applications Java en gérant les fichiers d'images vectorielles EMF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-java.svg" pfName="Aspose.Drawing" subTitlepfName="pour Java" downloadUrl="https://releases.aspose.com/drawing/java/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour Java" >}}


{{% blocks/products/pf/agp/content h2="Comment créer un fichier image EMF à l'aide du Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un EMF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image EMF - Java" offSpacer="" %}}
