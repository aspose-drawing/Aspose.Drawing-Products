---
title: เพิ่มรูปภาพลงในไฟล์รูปภาพ BMP ผ่าน .NET
weight: 20
url: /th/net/edit-image/add-image/bmp/
description: เพิ่มรูปภาพลงในบิตแมปรูปภาพ BMP ผ่าน .NET
keywords: add image to bitmap, add image to BMP, add image via C#, 2D graphics, drawing API, edit bitmap C#, Drawing สำหรับ .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw image, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มรูปภาพลงในบิตแมปรูปภาพ BMP ผ่าน C#" h2="แปลงรูปภาพ BMP: เพิ่มรูปภาพด้วย API การวาด .NET" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีเพิ่มรูปภาพใหม่ให้กับไฟล์รูปภาพ BMP ที่มีอยู่โดยใช้ C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
ยกระดับภาพ BMP ของคุณด้วยการผสานรวมภาพเพิ่มเติมได้อย่างราบรื่นโดยใช้ <a href="https://products.aspose.com/drawing/net">Aspose.Drawing สำหรับ .NET</a> API อเนกประสงค์ เครื่องมืออันทรงพลังนี้มอบวิธีที่เรียบง่ายแต่มีประสิทธิภาพในการปรับปรุงภาพของคุณ ด้วยการควบคุมความสามารถของคลาส Bitmap และการวาดภาพกราฟิกแรสเตอร์ คุณสามารถรวมรูปภาพลงในไฟล์ BMP ของคุณได้อย่างง่ายดาย ไม่ว่าคุณจะทำงานกับภาพแรสเตอร์หรือบันทึกไฟล์ในรูปแบบ BMP Drawing API มอบความยืดหยุ่นและประสิทธิภาพที่เหนือชั้น สัมผัสความสะดวกสบายในการเพิ่มรูปภาพลงในไฟล์ BMP ด้วย Drawing API ของ .NET และปลดล็อกความเป็นไปได้ใหม่ๆ สำหรับโปรเจ็กต์แก้ไขรูปภาพของคุณวันนี้ เปิด <a href="https://www.nuget.org/packages/aspose.drawing">นูเก็ต</a> ผู้จัดการแพ็คเกจและค้นหา <b>Aspose.Drawing</b> และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console</p>
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่มรูปภาพให้กับรูปภาพ BMP ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มรูปภาพลงในไฟล์รูปภาพ BMP - C#" offSpacer="" %}}
