---
title: Aspose. การวาดภาพสำหรับ .NET | ระบบข้ามแพลตฟอร์ม การวาดภาพ การทดแทนทั่วไป 
weight: 20
url: /th/net/ 
description: ไลบรารีกราฟิก .NET สำหรับการวาดข้อความ รูปทรงเรขาคณิต และรูปภาพ เพื่อแทนที่แพ็คเกจ System. Drawing.Common โดยตรงโดยไม่ต้องเปลี่ยนโค้ด C# ที่มีอยู่
---
...
<p align="justify">
 สามารถใช้แพ็คเกจ Aspose. Drawing เพื่อแทนที่การอ้างอิงแพ็คเกจ System. Drawing.Common ในโปรเจ็กต์ของคุณได้โดยตรง - โค้ดที่มีอยู่ทั้งหมดของคุณโดยใช้ System. Drawing API จะยังคงใช้งานได้ แต่ขณะนี้บนแพลตฟอร์มที่รองรับ .NET แล้ว ไลบรารีรูปวาดรองรับการเรนเดอร์กราฟิกแบบเวกเตอร์ เช่น เส้น เส้นโค้ง และตัวเลข รวมถึงข้อความในแบบอักษร ขนาด และสไตล์ที่หลากหลายลงบนภาพแรสเตอร์ สามารถบันทึกรูปภาพในรูปแบบกราฟิกที่ใช้กันทั่วไปทั้งหมด รวมถึง BMP, PNG, JPEG, GIF และ TIFF Aspose. Drawing เป็นไลบรารี .NET ล้วนๆ และไม่ต้องพึ่งพากลไกการเรนเดอร์เนทิฟภายนอกใดๆ
</p>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API การประมวลผลรูปวาด .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose. Drawing สำหรับ .NET รองรับ [รูปแบบรูปภาพ](https://docs.aspose.com/drawing/net/supported-file-formats/) ต่อไปนี้" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="h2title">
    คุณสมบัติ .NET Graphics API ขั้นสูง
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose. Drawing สำหรับ .NET ช่วยให้สามารถวาดกราฟิกเวกเตอร์ต่างๆ เช่น ส่วนโค้ง, Cardinal Spline, Bezier spline, วงรี, เส้นโค้งปิด, เส้น และประเภทอื่นๆ อีกหลายประเภท ต้องใช้โค้ดเพียงไม่กี่บรรทัดในการวาดกราฟิกเวกเตอร์ประเภทต่างๆ โดยใช้ API เช่นนี่คือโค้ดสำหรับการวาดส่วนโค้ง
    </p>
