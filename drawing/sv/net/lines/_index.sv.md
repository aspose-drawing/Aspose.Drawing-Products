---
title: Skapa linjebildfil via .NET
weight: 20
url: /sv/net/lines/
description: Skapa linjebildfil via .NET.
keywords: create Linje via C#, 2D graphics, drawing API, create bitmap C#, Drawing för .NET, save bitmap, save Linje image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Linje image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Skapa linjebildfil via C#" h2="Bygg dina anpassade .NET-applikationer för att rita med linjebildfiler" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="för .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skapa linje via C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Process Linje via gratis onlineapp" sectionDescription="Skapa Linje-bilder, samt lägg till text till bilder genom att besöka vår [Live Demos-webbplats](https://products.aspose.app/drawing) Livedemon har följoche fördelar:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Få omedelbart nedladdningslänken för den resulteroche linjefilen" >}}
