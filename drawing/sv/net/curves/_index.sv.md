---
title: Skapa kurvbildsfil via .NET
weight: 20
url: /sv/net/curves/
description: Skapa kurvbildsfil via .NET.
Keywords: create Kurva via C#, 2D graphics, drawing API, create bitmap C#, Drawing för .NET, save bitmap, save Kurva image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Kurva image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skapa kurva via C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Processkurva via gratis onlineapp" sectionDescription="Skapa kurvbilder, samt lägg till text till bilder genom att besöka vår [webbplats för Live Demos](https://products.aspose.app/drawing) Livedemon har följoche fördelar:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Skaffa omedelbart nedladdningslänken för den resulteroche Kurva-filen" >}}
