---
title: Utwórz plik obrazu Krzywa za pomocą .NET
weight: 20
url: /pl/net/curves/
description: Utwórz plik obrazu Krzywa za pomocą .NET.
Keywords: create Krzywa via C#, 2D graphics, drawing API, create bitmap C#, Drawing dla .NET, save bitmap, save Krzywa image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Krzywa image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki tworzenia krzywej za pomocą C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Krzywa procesu za pośrednictwem bezpłatnej aplikacji internetowej" sectionDescription="Twórz obrazy Krzywa i dodawaj do nich tekst, odwiedzając naszą [stronę internetową z demonstracjami na żywo](https://products.aspose.app/drawing). Wersja demonstracyjna na żywo ma następujące zalety:" >}}
