---
title: เพิ่มพื้นหลังให้กับไฟล์ภาพ BMP ผ่าน .NET
weight: 20
url: /th/net/edit-image/add-background/bmp/
description: เพิ่มพื้นหลังให้กับไฟล์ภาพ BMP ผ่าน .NET
keywords: add background to image, add background to BMP, add background via C#, 2D graphics, drawing API, edit bitmap C#, Drawing สำหรับ .NET, save bitmap, save BMP image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw background, rendering raster images, BMP image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มพื้นหลังให้กับไฟล์ภาพ BMP ผ่าน C#" h2="ปรับแต่งรูปภาพ BMP ด้วยพื้นหลังโดยใช้การวาด .NET API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีเพิ่มพื้นหลังให้กับไฟล์ภาพ BMP โดยใช้ C#" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
ปลดล็อกความเป็นไปได้ใหม่ๆ ในการสร้างสรรค์สำหรับไฟล์ภาพ BMP ของคุณโดยการผสมผสานพื้นหลังเข้าด้วยกันอย่างลงตัว <a href="https://products.aspose.com/drawing/net">Aspose.Drawing สำหรับ .NET</a> เอพีไอ ไม่ว่าคุณกำลังมองหาการเพิ่มความลึก บริบท หรือความน่าสนใจทางภาพให้กับรูปภาพของคุณ เครื่องมืออเนกประสงค์นี้จะช่วยให้คุณทำได้อย่างง่ายดาย ด้วย Aspose.Drawing API การเพิ่มพื้นหลังให้กับรูปภาพ BMP นั้นใช้งานง่ายและมีประสิทธิภาพ ใช้ C# เพื่อวาดพื้นหลังลงบนภาพของคุณ โดยใช้ประโยชน์จากคลาสบิตแมปและความสามารถในการวาดกราฟิกแรสเตอร์เพื่อผลลัพธ์ที่แม่นยำและปรับแต่งได้ สัมผัสประสบการณ์ความยืดหยุ่นและพลังของการเพิ่มพื้นหลังให้กับภาพ BMP ด้วย Aspose.Drawing และยกระดับโครงการแก้ไขภาพของคุณได้อย่างง่ายดาย เปิด <a href="https://www.nuget.org/packages/aspose.drawing">นูเก็ต</a> ผู้จัดการแพ็คเกจและค้นหา <b>Aspose.Drawing</b> และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console</p>
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่มพื้นหลังให้กับรูปภาพ BMP ผ่าน C#" %}}
...
+ บันทึกบิตแมปที่แก้ไขในรูปแบบภาพ BMP
...
{{% blocks/products/pf/agp/code-block title="เพิ่มพื้นหลังให้กับไฟล์รูปภาพ BMP - C#" offSpacer="" %}}
