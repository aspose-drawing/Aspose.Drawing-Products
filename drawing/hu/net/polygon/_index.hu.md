---
title: Hozzon létre sokszög képfájlt a .NET segítségével
weight: 20
url: /hu/net/polygon/
description: Hozzon létre sokszög képfájlt a .NET segítségével.
Keywords: create Poligon via C#, 2D graphics, drawing API, create bitmap C#, Drawing .NET-hoz, save bitmap, save Poligon image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Poligon image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hozzon létre sokszög képfájlt a C# segítségével" h2="Készítse el egyedi .NET alkalmazásait Poligon képfájlokkal való rajzoláshoz" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET-hoz" downloadUrl="https://releases.aspose.com/drawing/net/" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="A sokszög létrehozásának lépései a C# segítségével" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Sokszög feldolgozása ingyenes online alkalmazáson keresztül" sectionDescription="Hozzon létre Poligon képeket, valamint adjon hozzá szöveget a képekhez [Élő bemutatók webhelyén](https://products.aspose.app/drawing) Az élő bemutató a következő előnyökkel jár:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Azonnal megkapja a letöltési linket az eredményül kapott sokszögfájlhoz" >}}
