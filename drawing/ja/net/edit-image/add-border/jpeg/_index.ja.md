---
title: .NET経由でJPEG画像ファイルに枠線を追加
weight: 20
url: /ja/net/edit-image/add-border/jpeg/
description: .NET経由でJPEG画像ファイルに枠線を追加します。
keywords: add border to image, add border to JPEG, add border via C#, 2D graphics, drawing API, edit bitmap C#, Drawing .NET用, save bitmap, save JPEG image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, draw border, rendering raster images, JPEG image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#経由でJPEG画像ファイルに枠線を追加" h2=".NET 描画 API を使用して JPEG 画像を境界線で強化する" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName=".NET用" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName=".NET用" >}}


{{% blocks/products/pf/agp/content h2="C#を使用してJPEG画像ファイルに枠線を追加する方法" %}}

<p align="justify" style="text-indent:50px;font-size:15px;">
を使用して境界線を追加することで、JPEG 画像を簡単に変換できます。 <a href="https://products.aspose.com/drawing/net">Aspose.Drawing用.NET用</a> API。このクロスプラットフォーム 2D グラフィック ライブラリは、境界線を画像にシームレスに統合するための強力なツールを提供します。 Aspose.Drawing API を使用すると、C# を使用して JPEG 画像の周囲に境界線を簡単に描くことができます。 Bitmap クラスとラスター グラフィックスの描画機能を利用して、プロ品質の結果を実現します。ラスター イメージをレンダリングする場合でも、JPEG ファイルを保存する場合でも、Drawing API はビジュアルを強化するために必要な柔軟性と機能を提供します。 .NET の API を使用して JPEG 画像に枠線を追加する便利さを体験し、画像編集プロセスを今すぐ向上させてください。開ける <a href="https://www.nuget.org/packages/aspose.drawing">NuGet</a> パッケージマネージャーを開き、次を検索します <b>Aspose.Drawing</b> そしてインストールします。パッケージ マネージャー コンソールから次のコマンドを使用することもできます。</p>
...
{{% blocks/products/pf/agp/feature-section-col title="C# 経由で JPEG 画像に枠線を追加する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="JPEG 画像ファイルに枠線を追加 - C#" offSpacer="" %}}
