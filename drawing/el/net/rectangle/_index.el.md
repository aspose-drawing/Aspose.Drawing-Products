---
title: Δημιουργήστε αρχείο εικόνας Ορθογώνιο παραλληλόγραμμο μέσω .NET
weight: 20
url: /el/net/rectangle/
description: Δημιουργήστε αρχείο εικόνας Ορθογώνιο παραλληλόγραμμο μέσω .NET.
Keywords: create Ορθογώνιο παραλληλόγραμμο via C#, 2D graphics, drawing API, create bitmap C#, Drawing για .NET, save bitmap, save Ορθογώνιο παραλληλόγραμμο image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Ορθογώνιο παραλληλόγραμμο image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη δημιουργία ορθογωνίου μέσω C#" %}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Λάβετε αμέσως τον σύνδεσμο λήψης για το αρχείο Ορθογώνιο παραλληλόγραμμο που προκύπτει" >}}
