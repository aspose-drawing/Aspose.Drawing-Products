---
title: GIF görüntü dosyasının arka planını .NET aracılığıyla değiştirin
weight: 20
url: /tr/net/edit-image/change-background/gif/
description: .NET aracılığıyla GIF dosyası için görüntü arka planını değiştirme.
keywords: change image background, change GIF background, change background via C#, 2D graphics, drawing API, edit background in C#, Drawing .NET için, save bitmap, save GIF image, cross-platform 2D graphic library, Bitmap class, raster graphics drawing, rendering raster images, GIF image file
---
...
{{% blocks/products/pf/agp/feature-section-col title="Arka planı C# aracılığıyla GIF görüntüsüne değiştirme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF Görüntü Dosyasının arka planını değiştirin - C#" offSpacer="" %}}
