---
title: สร้างไฟล์ภาพ การตัด ด้วย .NET
weight: 20
url: /th/net/clipping/
description: สร้างไฟล์ภาพ การตัด ด้วย .NET
Keywords: create การตัด via C#, 2D graphics, drawing API, create bitmap C#, Drawing สำหรับ .NET, save bitmap, save การตัด image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, การตัด image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ภาพ การตัด ด้วย C#" h2="สร้างแอพพลิเคชั่น .NET ที่คุณกำหนดเองสำหรับการวาดภาพด้วยไฟล์ภาพการคลิป" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="สำหรับ .NET" >}}


{{% blocks/products/pf/agp/content h2="วิธีสร้างไฟล์ภาพตัดต่อโดยใช้ C#" %}}

ค้นพบความเรียบง่ายของการสร้างไฟล์ภาพ การตัด ด้วย C# เอกสารนี้ให้ข้อมูลเชิงลึกและคำแนะนำที่สำคัญ ไม่ว่าคุณจะเป็นนักพัฒนาที่มีประสบการณ์หรือเพิ่งเริ่มต้น เรียนรู้ขั้นตอนในการรวมการสร้างภาพการตัดภาพเข้ากับโปรเจ็กต์ของคุณได้อย่างราบรื่น และเพิ่มพูนทักษะการเขียนโปรแกรมของคุณ ในการสร้างไฟล์ การตัด เราจะใช้ไลบรารี [Aspose.Drawing สำหรับ .NET](https://products.aspose.com/drawing/net) ซึ่งเป็น API การวาดภาพกราฟิก 2D ที่มีคุณสมบัติหลากหลาย ทรงพลัง และใช้งานง่ายสำหรับ C# แพลตฟอร์ม. เปิดตัวจัดการแพ็คเกจ [นูเก็ต](https://www.nuget.org/packages/aspose.drawing) seเส้นโค้งh สำหรับ **Aspose.Drawing** และติดตั้ง คุณอาจใช้คำสั่งต่อไปนี้จาก Package Manager Console
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการสร้าง การตัด ผ่าน C#" %}}
...
+ ตั้งค่า Textกำลังเรนเดอร์Hint
+ สร้างสี่เหลี่ยมขอบ
+ สร้างเส้นทางคลิป
+ ตั้งค่าเส้นขอบให้กับคลิป
+ ตั้งค่าคลิปเป็นกราฟิก
+ สร้างและตั้งค่าสตริงข้อความ
+ วาดองค์ประกอบกราฟิก
...
{{% blocks/products/pf/agp/code-block title="สร้างไฟล์ภาพตัด - C#" offSpacer="" %}}
{{< gist "aspose-com-gists" "8b1dc03ab805ef18eea88d4c442331e9" "Examples-CSharp-Drawการตัด.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ประมวลผลการตัดผ่านแอปออนไลน์ฟรี" sectionDescription="สร้างภาพตัดต่อ รวมถึงเพิ่มข้อความลงในภาพโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/drawing) การสาธิตสดมีคุณประโยชน์ดังต่อไปนี้:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="รับลิงค์ดาวน์โหลดสำหรับไฟล์ การตัด ที่เป็นผลลัพธ์ทันที" >}}
