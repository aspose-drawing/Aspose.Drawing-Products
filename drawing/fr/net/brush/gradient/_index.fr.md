---
title: Créer un fichier image pinceau via .NET
weight: 20
url: /fr/net/brush/gradient
description: Créez un fichier image pinceau via le .NET.
Keywords: create Brush via C#, 2D graphics, drawing API, create bitmap C#, Drawing pour .NET, save bitmap, save Brush image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Brush image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier image pinceau dégradé via C#" h2="Créez vos applications .NET personnalisées pour dessiner avec des fichiers image Brush" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="pour .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="pour .NET" >}}


{{% blocks/products/pf/agp/content h2="Comment créer un fichier image de pinceau dégradé à l'aide du C#" %}}

Découvrez la simplicité de création de fichiers image Brush avec le C#. Ce document fournit des informations et des conseils essentiels, que vous soyez un développeur chevronné ou débutant. Découvrez les étapes pour intégrer de manière transparente la création d’images Brush dans vos projets et améliorer vos compétences en programmation. Afin de créer des fichiers Brush, nous utiliserons la bibliothèque [Aspose.Drawing pour .NET](https://products.aspose.com/drawing/net) qui est une API de dessin graphique 2D riche en fonctionnalités, puissante et facile à utiliser pour C#. plate-forme. Ouvrez le gestionnaire de packages [NuGet](https://www.nuget.org/packages/aspose.drawing), seCourbeh pour **Aspose.Drawing** et installez. Vous pouvez également utiliser la commete suivante à partir de la console Package Manager.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un pinceau via le C#" %}}
...
+ Créez un pinceau avec la couleur centrale.
+ Créez une gamme de couleurs surround.
+ Définissez les couleurs surround sur le pinceau.
+ Dessinez des éléments graphiques de courbe.
...
{{% blocks/products/pf/agp/code-block title="Créer un fichier image de pinceau dégradé - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Traitez le pinceau via une application en ligne gratuite" sectionDescription="Créez des images Brush et ajoutez du texte aux images en visitant notre [site Web de démonstrations en direct](https://products.aspose.app/drawing). La démo en direct présente les avantages suivants :" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenez instantanément le lien de téléchargement du fichier Brush résultant" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/net/brushes/solid" name="Brosse solide" description="Pinceau dégradé Image graphique réseau portable" >}}
