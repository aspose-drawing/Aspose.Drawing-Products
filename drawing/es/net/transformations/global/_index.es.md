---
title: Transformar archivo de imagen a través de .NET
weight: 20
url: /es/net/transformation/global
description: Transforme el archivo de imagen a través de .NET.
Keywords: Transform via C#, 2D graphics, drawing API, create bitmap C#, Drawing para .NET, save bitmap, save Mezcla alfa image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, update image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crear archivo de imagen transformada a través de C#" h2="Cree sus aplicaciones .NET personalizadas para transformar archivos de imágenes" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="para .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="para .NET" >}}


{{% blocks/products/pf/agp/content h2="Cómo hacer una transformación global de un archivo de imagen usando C#" %}}

Descubra la simplicidad de la transformación global de archivos de imágenes con C#. Este documento proporciona información y orientación esenciales, ya sea que sea un desarrollador experimentado o recién esté comenzando. Conozca los pasos para incorporar perfectamente la creación de imágenes combinadas Alpha en sus proyectos y mejorar sus habilidades de programación. Para crear archivos de combinación Alpha, usaremos la biblioteca [Aspose.Drawing para .NET](https://products.aspose.com/drawing/net), que es una API de dibujo de gráficos 2D potente, fácil de usar y rica en funciones para Plataforma C#. Abra el administrador de paquetes [NuGet](https://www.nuget.org/packages/aspose.drawing), seleccioneCurvah para **Aspose.Drawing** e instálelo. También puede utilizar el siguiente comando desde la Consola del Administrador de paquetes.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para transformarse a través de C#" %}}
...
+ Ubicar el área para realizar la transformación.
...
{{% blocks/products/pf/agp/code-block title="Realice una transformación global a un archivo de imagen - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Procese la transformación global a través de una aplicación gratuita en línea" sectionDescription="Cree imágenes transformadas y agregue texto a las imágenes visitando nuestro [sitio web de demostraciones en vivo] (https://products.aspose.app/drawing). La demostración en vivo tiene los siguientes beneficios:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Obtenga instantáneamente el enlace de descarga para el archivo de combinación Alpha resultante" >}}
