...
{{< blocks/products/pf/carousel-item h3="Num relance" description="Uma visão geral do Aspose.Drawing para API .NET." >}}
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de processamento de desenho .NET" src="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/aspose_drawing-for-net.svg"/>
  <header>
   Aspose.Drawing
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.Drawing para .NET suporta os seguintes [formatos de imagem](https://docs.aspose.com/drawing/net/supported-file-formats/)." >}}
