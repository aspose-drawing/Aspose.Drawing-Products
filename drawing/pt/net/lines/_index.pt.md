...
{{% blocks/products/pf/agp/content h2="Como criar arquivo de imagem de linha usando C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Linha de processo via aplicativo online gratuito" sectionDescription="Crie imagens de linha e adicione texto às imagens visitando nosso [site de demonstrações ao vivo](https://products.aspose.app/drawing). A demonstração ao vivo tem os seguintes benefícios:" >}}
