---
title: Skapa polygonbildfil via .NET
weight: 20
url: /sv/net/polygon/
description: Skapa polygonbildfil via .NET.
Keywords: create Polygon via C#, 2D graphics, drawing API, create bitmap C#, Drawing för .NET, save bitmap, save Polygon image, cross-platform 2D graphic library, Bitmap class, vector graphics drawing, draw text, rendering raster images, Polygon image file
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Skapa polygonbildfil via C#" h2="Bygg dina anpassade .NET-applikationer för att rita med polygonbildfiler" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/drawing/headers/aspose_drawing-for-net.svg" pfName="Aspose.Drawing" subTitlepfName="för .NET" downloadUrl="https://releases.aspose.com/drawing/net/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Drawing" subTitlepfName="för .NET" >}}


{{% blocks/products/pf/agp/content h2="Hur man skapar polygonbildfil med C#" %}}

Upptäck enkelheten i att skapa polygonbildfiler med C#. Det här dokumentet ger viktiga insikter och vägledning, oavsett om du är en erfaren utvecklare eller precis har börjat. Lär dig stegen för att sömlöst integrera polygonbildskapoche i dina projekt och förbättra dina programmeringsfärdigheter. För att skapa polygonfiler använder vi biblioteket [Aspose.Drawing för .NET](https://products.aspose.com/drawing/net), som är ett funktionsrikt, kraftfullt och lättanvänt 2D-grafikritnings-API för C# plattform. Öppna [NuGet](https://www.nuget.org/packages/aspose.drawing) pakethanteraren, seKurvah för **Aspose.Drawing** och installera. Du kan också använda följoche kommocho från Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skapa polygon via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Skapa polygonbildfil - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bearbeta polygon via gratis onlineapp" sectionDescription="Skapa polygonbilder, samt lägg till text till bilder genom att besöka vår [webbplats för Live Demos](https://products.aspose.app/drawing) Livedemon har följoche fördelar:" >}}
...
{{< blocks/products/pf/agp/democard icon="fa-download" text="Skaffa omedelbart nedladdningslänken för den resulteroche polygonfilen" >}}
